...
var V1 = (r, e, n) =>
  e in r ? Y1(r, e, {enumerable: !0, configurable: !0, writable: !0, value: n}) : (r[e] = n)
var W = (r, e, n) => (V1(r, typeof e != 'symbol' ? e + '' : e, n), n)
const Nl = typeof navigator > 'u' ? !1 : navigator.product === 'ReactNative',
  ql = {timeout: Nl ? 6e4 : 12e4},
  Z1 = function (r) {
    const e = {
      ...ql,
    ...
    if (((e.timeout = Wl(e.timeout)), e.query)) {
      ...
      for (const [u, a] of Object.entries(e.query)) {
        if (a !== void 0)
          if (Array.isArray(a)) for (const l of a) s.append(u, l)
          else s.append(u, a)
        const f = s.toString()
        f && (e.url = `${n}?${f}`)
      }
...
function Q1(r) {
  const e = r.indexOf('?')
  if (e === -1) return {url: r, searchParams: new URLSearchParams()}
  const n = r.slice(0, e),
    s = r.slice(e + 1)
  if (!Nl) return {url: n, searchParams: new URLSearchParams(s)}
...
const tw = /^https?:\/\//i,
  ew = function (r) {
    if (!tw.test(r.url)) throw new Error(`"${r.url}" is not a valid URL`)
  }
function nw(r) {
...
const sw = ['request', 'response', 'progress', 'error', 'abort'],
  zf = [
    'processOptions',
    'validateOptions',
    'interceptRequest',
...
function Bl(r, e) {
  ...
  function u(a) {
    const f = (I, O, R) => {
      ...
      l = sw.reduce((I, O) => ((I[O] = iw()), I), {}),
      d = rw(s),
      y = d('processOptions', a)
    d('validateOptions', y)
...
`),
  ...
  fw = (r, e, n) =>
    e in r ? cw(r, e, {enumerable: !0, configurable: !0, writable: !0, value: n}) : (r[e] = n),
  Ke = (r, e, n) => fw(r, typeof e != 'symbol' ? e + '' : e, n),
  Gl = (r, e, n) => e.has(r) || Hl('Cannot ' + n),
  Ne = (r, e, n) => (Gl(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  ur = (r, e, n) =>
    e.has(r)
      ? Hl('Cannot add the same private member more than once')
      : e instanceof WeakSet
        ? e.add(r)
        : e.set(r, n),
  Nn = (r, e, n, s) => (Gl(r, e, 'write to private field'), e.set(r, n), n),
  Fs,
  Ms,
  Mr,
  Ds,
...
class ju {
  constructor() {
    Ke(this, 'onabort'),
      ...
      Ke(this, 'ontimeout'),
      Ke(this, 'readyState', 0),
      Ke(this, 'response'),
      Ke(this, 'responseText', ''),
      Ke(this, 'responseType', ''),
      Ke(this, 'status'),
      Ke(this, 'statusText'),
      Ke(this, 'withCredentials'),
      ur(this, Fs),
      ur(this, Ms),
      ur(this, Mr),
      ur(this, Ds, {}),
  ...
  open(e, n, s) {
    ...
    Nn(this, Fs, e),
      ...
      Nn(this, Mr, ''),
      (this.readyState = 1),
      (u = this.onreadystatechange) == null || u.call(this),
      Nn(this, qn, void 0)
  }
  abort() {
  ...
  send(e) {
    ...
    typeof AbortController == 'function' &&
      Ne(this, ks) &&
      (Nn(this, qn, new AbortController()),
      typeof EventTarget < 'u' &&
        Ne(this, qn).signal instanceof EventTarget &&
        (s.signal = Ne(this, qn).signal)),
      typeof document < 'u' && (s.credentials = this.withCredentials ? 'include' : 'omit'),
      fetch(Ne(this, Ms), s)
        .then((u) => {
          var a
          return (
            u.headers.forEach((f, l) => {
              Nn(
                this,
                Mr,
                Ne(this, Mr) +
...
`,
            ...
            (this.readyState = 3),
            (a = this.onreadystatechange) == null || a.call(this),
            n ? u.text() : u.arrayBuffer()
          )
        })
        .then((u) => {
          var a
          typeof u == 'string' ? (this.responseText = u) : (this.response = u),
            (this.readyState = 4),
            (a = this.onreadystatechange) == null || a.call(this)
        })
        .catch((u) => {
...
const zu = typeof XMLHttpRequest == 'function' ? 'xhr' : 'fetch',
  lw = zu === 'xhr' ? XMLHttpRequest : ju,
  hw = (r, e) => {
    var n
    const s = r.options,
      u = r.applyMiddleware('finalizeOptions', s),
      a = {},
      f = r.applyMiddleware('interceptRequest', void 0, {
        adapter: zu,
        context: r,
      })
    if (f) {
    ...
    let l = new lw()
    l instanceof ju &&
      typeof u.fetch == 'object' &&
      l.setInit(u.fetch, (n = u.useAbortSignal) != null ? n : !0)
    const d = u.headers,
      y = u.timeout
    let p = !1,
      m = !1,
    ...
    if (
      ((l.onerror = (M) => {
        l instanceof ju
          ? x(
              M instanceof Error
                ? M
                : new Error(`Request error while attempting to reach is ${u.url}`, {cause: M}),
            )
          : x(
              new Error(
      ...
      (l.withCredentials = !!u.withCredentials),
      d && l.setRequestHeader)
    )
      for (const M in d) d.hasOwnProperty(M) && l.setRequestHeader(M, d[M])
    return (
      u.rawBody && (l.responseType = 'arraybuffer'),
      r.applyMiddleware('onRequest', {options: u, adapter: zu, request: l, context: r}),
      l.send(u.body || null),
      y && (a.connect = setTimeout(() => I('ETIMEDOUT'), y.connect)),
      {abort: C}
    )
    function C() {
      ;(p = !0), l && l.abort()
    ...
    function R(M) {
      ;(M || p || (l.readyState >= 2 && a.connect)) && clearTimeout(a.connect),
        a.socket && clearTimeout(a.socket)
    }
    function x(M) {
      if (m) return
      R(!0), (m = !0), (l = null)
    ...
    function D() {
      return {
        body:
          l.response || (l.responseType === '' || l.responseType === 'text' ? l.responseText : ''),
        url: u.url,
        method: u.method,
...
function pw() {
  ...
  $u = function (p, m) {
    m = m || {}
    var b = typeof p
    if (b === 'string' && p.length > 0) return f(p)
    if (b === 'number' && isFinite(p)) return m.long ? d(p) : l(p)
...
function gw(r) {
  ...
  function e(p) {
    let m = 0
    for (let b = 0; b < p.length; b++) (m = (m << 5) - m + p.charCodeAt(b)), (m |= 0)
  ...
  function n(p) {
    ...
    function O(...R) {
      ...
      ;(R[0] = R[0].replace(/%([a-zA-Z%])/g, (z, ht) => {
        ...
        n.formatArgs.call(x, R),
        (x.log || n.log).apply(x, R)
    }
    return (
      (O.namespace = p),
      (O.useColors = n.useColors()),
      (O.color = n.selectColor(p)),
      (O.extend = s),
      (O.destroy = n.destroy),
      Object.defineProperty(O, 'enabled', {
        ...
        configurable: !1,
        get: () =>
          b !== null ? b : (C !== n.namespaces && ((C = n.namespaces), (I = n.enabled(p))), I),
        set: (R) => {
          b = R
        },
      }),
  ...
  function u(p) {
    ...
    let m
    const b = (typeof p == 'string' ? p : '').split(/[\s,]+/),
      C = b.length
    for (m = 0; m < C; m++)
      b[m] &&
        ((p = b[m].replace(/\*/g, '.*?')),
  ...
  function a() {
    const p = [...n.names.map(l), ...n.skips.map(l).map((m) => '-' + m)].join(',')
    return n.enable(''), p
  }
  function f(p) {
    if (p[p.length - 1] === '*') return !0
    let m, b
    for (m = 0, b = n.skips.length; m < b; m++) if (n.skips[m].test(p)) return !1
    for (m = 0, b = n.names.length; m < b; m++) if (n.names[m].test(p)) return !0
    return !1
  }
  function l(p) {
    return p
    ...
    return (
      ...
      navigator.userAgent.toLowerCase().match(/(edge|trident)\/(\d+)/)
        ...
        : (typeof document < 'u' &&
          ...
          (typeof window < 'u' &&
            console &&
            (console.firebug || (console.exception && console.table))) || // Is firefox >= v31?
...
function yw(r) {
  ...
  const n = e.prototype
  return !(
    Xf(n) === !1 || // eslint-disable-next-line no-prototype-builtins
    ...
    processOptions: (r) => {
      ...
      return !e ||
        !(
          ...
          !mw(e) &&
          (ww.indexOf(typeof e) !== -1 || Array.isArray(e) || yw(e))
        )
        ? r
        : Object.assign({}, r, {
...
function _w(r) {
  return {
    onResponse: (n) => {
      const s = n.headers['content-type'] || '',
        u = (r && r.force) || s.indexOf('application/json') !== -1
...
function Ew(r = {}) {
  ...
  return {
    onReturn: (n, s) =>
      new e(
        (u) => (
          n.error.subscribe((a) => u.error(a)),
          n.progress.subscribe((a) => u.next(Object.assign({type: 'progress'}, a))),
...
function Aw() {
  return {
    onRequest: (r) => {
      ...
      const e = r.request,
        n = r.context
      'upload' in e && 'onprogress' in e.upload && (e.upload.onprogress = s('upload')),
        'onprogress' in e && (e.onprogress = s('download'))
      function s(u) {
        return (a) => {
...
var xw = Object.defineProperty,
  Sw = (r, e, n) =>
    e in r ? xw(r, e, {enumerable: !0, configurable: !0, writable: !0, value: n}) : (r[e] = n),
  Si = (r, e, n) => Sw(r, typeof e != 'symbol' ? e + '' : e, n)
class Rw {
  constructor(e) {
  ...
  return {
    onError: (u, a) => {
      const f = a.options,
        ...
        y = f.shouldRetry || s,
        p = f.attemptNumber || 0
      if (Iw(f.body) || !y(u, p, f) || p >= l) return u
...
var Ku = function (r, e) {
  return (
    (Ku =
      ...
      function (n, s) {
        for (var u in s) Object.prototype.hasOwnProperty.call(s, u) && (n[u] = s[u])
      }),
    Ku(r, e)
  )
}
...
function zl(r, e) {
  var n = {
    ...
    f
  return (
    (f = {next: l(0), throw: l(1), return: l(2)}),
    ...
    for (; f && ((f = 0), y[0] && (n = 0)), n; )
      try {
        if (
          ...
          u &&
            (a =
              y[0] & 2 ? u.return : y[0] ? u.throw || ((a = u.return) && a.call(u), 0) : u.next) &&
            !(a = a.call(u, y[1])).done)
        )
          return a
        switch (((u = 0), a && (y = [y[0] & 2, a.value]), y[0])) {
          ...
          default:
            if (
              ((a = n.trys), !(a = a.length > 0 && a[a.length - 1]) && (y[0] === 6 || y[0] === 2))
            ) {
              n = 0
              continue
            }
...
function Ye(r, e) {
  ...
  var s = n.call(r),
    ...
    f
  try {
    for (; (e === void 0 || e-- > 0) && !(u = s.next()).done; ) a.push(u.value)
  } catch (l) {
    f = {error: l}
  } finally {
    try {
...
function Pw(r) {
  ...
  return e
    ? e.call(r)
    : ((r = typeof zr == 'function' ? zr(r) : r[Symbol.iterator]()),
      (n = {}),
      s('next'),
      s('throw'),
      s('return'),
            ...
            try {
              for (var b = zr(m), C = b.next(); !C.done; C = b.next()) {
                ...
                try {
                  ...
                  ;(a = a ?? []),
                    O instanceof Pu ? (a = Ve(Ve([], Ye(a)), Ye(O.errors))) : a.push(O)
                }
              }
            } catch (O) {
              s = {error: O}
...
var Xl = {
  ...
  Xu = {
    setTimeout: function (r, e) {
      ...
      var u = Xu.delegate
      return u != null && u.setTimeout
        ? u.setTimeout.apply(u, Ve([r, e], Ye(n)))
        : setTimeout.apply(void 0, Ve([r, e], Ye(n)))
    },
...
var aa = (function (r) {
    ...
    function e(n) {
      ...
      return (
        (s.isStopped = !1), n ? ((s.destination = n), Jl(n) && n.add(s)) : (s.destination = Uw), s
      )
    }
    return (
      (e.create = function (n, s, u) {
        return new Ri(n, s, u)
      }),
      ...
      (e.prototype.unsubscribe = function () {
        this.closed ||
          ((this.isStopped = !0), r.prototype.unsubscribe.call(this), (this.destination = null))
      }),
    ...
    (e.prototype.unsubscribe = function () {
      ...
      if (!this.shouldUnsubscribe || this.shouldUnsubscribe()) {
        ...
        r.prototype.unsubscribe.call(this),
          !s && ((n = this.onFinalize) === null || n === void 0 || n.call(this))
      }
    }),
    e
  )
...
var Bw = (function (r) {
      ...
      (e.prototype.error = function (n) {
        ...
        Ns(function () {
          if ((s._throwIfClosed(), !s.isStopped)) {
            ...
            for (var u = s.observers; u.length; ) u.shift().error(n)
          }
        })
      }),
      (e.prototype.complete = function () {
        ...
        Ns(function () {
          if ((n._throwIfClosed(), !n.isStopped)) {
            n.isStopped = !0
            for (var s = n.observers; s.length; ) s.shift().complete()
          }
        })
      }),
      (e.prototype.unsubscribe = function () {
  ...
  Qf = (function (r) {
    ...
    return (
      (e.prototype.next = function (n) {
        var s, u
        ;(u = (s = this.destination) === null || s === void 0 ? void 0 : s.next) === null ||
          u === void 0 ||
          u.call(s, n)
      }),
      (e.prototype.error = function (n) {
        var s, u
        ;(u = (s = this.destination) === null || s === void 0 ? void 0 : s.error) === null ||
          u === void 0 ||
          u.call(s, n)
      }),
      (e.prototype.complete = function () {
        var n, s
        ;(s = (n = this.destination) === null || n === void 0 ? void 0 : n.complete) === null ||
          s === void 0 ||
          s.call(n)
      }),
      (e.prototype._subscribe = function (n) {
        var s, u
        return (u = (s = this.source) === null || s === void 0 ? void 0 : s.subscribe(n)) !==
          null && u !== void 0
          ? u
          : Kl
      }),
  ...
  jw = (function (r) {
    ...
    function e(n, s, u) {
      ...
      return (
        (a._bufferSize = n),
        (a._windowTime = s),
        (a._timestampProvider = u),
        (a._buffer = []),
        (a._infiniteTimeWindow = !0),
        (a._infiniteTimeWindow = s === 1 / 0),
        (a._bufferSize = Math.max(1, n)),
        (a._windowTime = Math.max(1, s)),
        a
      )
    }
    return (
      (e.prototype.next = function (n) {
        var s = this,
          u = s.isStopped,
          a = s._buffer,
          f = s._infiniteTimeWindow,
          l = s._timestampProvider,
          d = s._windowTime
        u || (a.push(n), !f && a.push(l.now() + d)),
          this._trimBuffer(),
          r.prototype.next.call(this, n)
      }),
      (e.prototype._subscribe = function (n) {
        this._throwIfClosed(), this._trimBuffer()
        for (
          var s = this._innerSubscribe(n),
            u = this,
            a = u._infiniteTimeWindow,
            f = u._buffer,
            l = f.slice(),
            d = 0;
          d < l.length && !n.closed;
      ...
      (e.prototype._trimBuffer = function () {
        ...
        if ((s < 1 / 0 && l < a.length && a.splice(0, a.length - l), !f)) {
          for (var d = u.now(), y = 0, p = 1; p < a.length && a[p] <= d; p += 2) y = p
          y && a.splice(0, y + 1)
        }
      }),
      e
...
function oh(r) {
  return new TypeError(
    'You provided ' +
      (r !== null && typeof r == 'object' ? 'an invalid object' : "'" + r + "'") +
...
function Xw(r) {
  return new Mt(function (e) {
    var n = r[ca]()
    if (bt(n.subscribe)) return n.subscribe(e)
    throw new TypeError('Provided object does not correctly implement Symbol.observable')
  })
}
function Yw(r) {
  return new Mt(function (e) {
    for (var n = 0; n < r.length && !e.closed; n++) e.next(r[n])
    e.complete()
  })
}
function Vw(r) {
    ...
    return zl(this, function (d) {
      switch (d.label) {
        ...
        case 1:
          return [4, n.next()]
        case 2:
          if (((s = d.sent()), !!s.done)) return [3, 4]
          if (((f = s.value), e.next(f), e.closed)) return [2]
          d.label = 3
        case 3:
          return [3, 1]
        case 4:
...
function ob(r, e) {
  if (r != null) {
    if (ih(r)) return eb(r, e)
    if (nh(r)) return rb(r, e)
    if (rh(r)) return nb(r, e)
    if (sh(r)) return ph(r, e)
    if (ah(r)) return ib(r, e)
    if (fh(r)) return sb(r, e)
  }
  throw oh(r)
}
function Ii(r, e) {
...
function vh() {
  ...
  var n = th(r)
  return n
    ? kw(vh.apply(void 0, Ve([], Ye(r))), fb(n))
    : me(function (s, u) {
        lb(Ve([s], Ye(vb(r))))(u)
      })
}
    ...
    ? me(function (u, a) {
        ...
        u.subscribe(
          ve(
            ...
            function () {
              var d, y
              l && ((d = s.unsubscribe) === null || d === void 0 || d.call(s)),
                (y = s.finalize) === null || y === void 0 || y.call(s)
            },
          ),
        )
      })
...
var wh = {
  ...
  la = {0: 8203, 1: 8204, 2: 8205, 3: 65279},
  xb = new Array(4).fill(String.fromCodePoint(la[0])).join('')
function Sb(r) {
  let e = JSON.stringify(r)
  return `${xb}${Array.from(e)
    .map((n) => {
      let s = n.charCodeAt(0)
      if (s > 255)
        throw new Error(
          `Only ASCII edit info can be encoded. Error attempting to encode ${e} on character ${n} (${s})`,
        )
      return Array.from(s.toString(4).padStart(4, '0'))
        .map((u) => String.fromCodePoint(la[u]))
        .join('')
    })
    .join('')}`
}
function Rb(r) {
  return !Number.isNaN(Number(r)) ||
    (/[a-z]/i.test(r) && !/\d+(?:[-:\/]\d+){2}(?:T\d+(?:[-:\/]\d+){1,2}(\.\d+)?Z?)?/.test(r))
    ? !1
    : !!Date.parse(r)
}
function Ib(r) {
...
var Tb = `${Object.values(wh)
    .map((r) => `\\u{${r.toString(16)}}`)
    .join('')}`,
  il = new RegExp(`[${Tb}]{4,}`, 'gu')
function Lb(r) {
  var e
...
var Fb = Object.defineProperty,
  Mb = (r, e, n) =>
    e in r ? Fb(r, e, {enumerable: !0, configurable: !0, writable: !0, value: n}) : (r[e] = n),
  Gn = (r, e, n) => (Mb(r, typeof e != 'symbol' ? e + '' : e, n), n)
class Db extends Error {
  constructor(e) {
    const n = bh(e)
    super(n.message),
      Gn(this, 'response'),
      Gn(this, 'statusCode', 400),
      Gn(this, 'responseBody'),
      Gn(this, 'details'),
...
function bh(r) {
  ...
  if (e.error && e.message) return (n.message = `${e.error} - ${e.message}`), n
  if (kb(e) || Nb(e)) {
    const s = e.error.items || [],
      u = s
        .slice(0, 5)
        .map((f) => {
          var l
...
- `)}`
    ...
    return (
      s.length > 5 &&
        (a += `
...and ${s.length - 5} more`),
      (n.message = `${e.error.description}${a}`),
      (n.details = e.error),
      n
    )
  }
  return e.error && e.error.description
    ? ((n.message = e.error.description), (n.details = e.error), n)
    : ((n.message = e.error || e.message || qb(r)), n)
}
function kb(r) {
  return (
    Ys(r) &&
...
function Nb(r) {
  return (
    Ys(r) && Ys(r.error) && r.error.type === 'actionError' && typeof r.error.description == 'string'
  )
}
function Ys(r) {
...
function Wb(r, e) {
  return (e.headers['content-type'] || '').toLowerCase().indexOf('application/json') !== -1
    ? JSON.stringify(r, null, 2)
    : r
}
const Bb = {
    onResponse: (r) => {
      if (r.statusCode >= 500) throw new Ub(r)
      if (r.statusCode >= 400) throw new Db(r)
      return r
    },
  },
  Hb = {
...
function Gb(r) {
  return dw([oa({shouldRetry: jb}), ...r, Hb, bw(), _w(), Aw(), Bb, Ew({implementation: Mt})])
}
function jb(r, e, n) {
  if (n.maxRetries === 0) return !1
  const s = n.method === 'GET' || n.method === 'HEAD',
    u = (n.uri || n.url).startsWith('/data/query'),
    a =
      r.response &&
...
function _h(r) {
  ...
  if (Array.isArray(r)) return {query: '*[_id in $ids]', params: {ids: r}}
  if (typeof r == 'object' && r !== null && 'query' in r && typeof r.query == 'string')
    return 'params' in r && typeof r.params == 'object' && r.params !== null
      ...
      : {query: r.query}
  const e = ['* Document ID (<docId>)', '* Array of document IDs', '* Object containing `query`']
    .join(`
`)
...
const sl = ['image', 'file'],
  ...
  Vs = (r, e) => {
    if (!e._id) throw new Error(`${r}() requires that the document contains an ID ("_id" property)`)
    Eh(r, e._id)
  },
  Jb = (r, e, n) => {
    ...
    if (!Array.isArray(n)) throw new Error(`${s} takes an "items"-argument which must be an array`)
  },
  Ah = (r) => {
    if (!r.dataset) throw new Error('`dataset` must be provided to perform queries')
    return r.dataset || ''
  },
  xh = (r) => {
...
var Xb = Object.defineProperty,
  Yb = (r, e, n) =>
    e in r ? Xb(r, e, {enumerable: !0, configurable: !0, writable: !0, value: n}) : (r[e] = n),
  ul = (r, e, n) => (Yb(r, typeof e != 'symbol' ? e + '' : e, n), n),
  Sh = (r, e, n) => {
    if (!e.has(r)) throw TypeError('Cannot ' + n)
  },
  Gr = (r, e, n) => (Sh(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  Rh = (r, e, n) => {
...
class Oh {
   ...
   */
  splice(e, n, s, u) {
    const a = typeof s > 'u' || s === -1,
      f = n < 0 ? n - 1 : n,
      l = a ? -1 : Math.max(0, n + s),
      d = f < 0 && l >= 0 ? '' : l,
      y = `${e}[${f}:${d}]`
...
const Vb = class Th extends Oh {
  ...
  commit(e) {
    ...
    const n = typeof this.selection == 'string',
      s = Object.assign({returnFirst: n, returnDocuments: !0}, e)
...
var Qb = Object.defineProperty,
  t_ = (r, e, n) =>
    e in r ? Qb(r, e, {enumerable: !0, configurable: !0, writable: !0, value: n}) : (r[e] = n),
  al = (r, e, n) => (t_(r, typeof e != 'symbol' ? e + '' : e, n), n),
  $h = (r, e, n) => {
    if (!e.has(r)) throw TypeError('Cannot ' + n)
  },
  jn = (r, e, n) => ($h(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  Ph = (r, e, n) => {
    if (e.has(r)) throw TypeError('Cannot add the same private member more than once')
    e instanceof WeakSet ? e.add(r) : e.set(r, n)
  },
...
const e_ = class Uh extends Dh {
  ...
  patch(e, n) {
    ...
    if (typeof e != 'string' && e instanceof Ai) return this._add({patch: e.serialize()})
    if (s) {
      const u = n(new Ai(e, {}, jn(this, cr)))
      if (!(u instanceof Ai)) throw new Error('function passed to `patch()` must return the patch')
...
const n_ = class Nh extends Dh {
  ...
  patch(e, n) {
    const s = typeof n == 'function'
    if (typeof e != 'string' && e instanceof Ei) return this._add({patch: e.serialize()})
    if (s) {
      const u = n(new Ei(e, {}, jn(this, fr)))
      if (!(u instanceof Ei)) throw new Error('function passed to `patch()` must return the patch')
      return this._add({patch: u.serialize()})
    }
    return this._add({patch: {id: e, ...n}})
  }
...
const Oi = (r) =>
  ...
  a_ = Oi([
    ...
    `See ${ha('js-client-browser-token')} for more information and how to hide this warning.`,
  ]),
  c_ = Oi([
  ...
  l_ = ['localhost', '127.0.0.1', '0.0.0.0'],
  h_ = (r) => l_.indexOf(r) !== -1
function d_(r) {
  if (r === '1' || r === 'X') return
  const e = new Date(r)
...
const Wh = function (r) {
  ...
  Bh = (r, e) => {
    ...
    if (u && !s.projectId) throw new Error('Configuration must contain `projectId`')
    ...
    if (
      s.stega.enabled &&
      typeof s.stega.studioUrl != 'string' &&
      typeof s.stega.studioUrl != 'function'
    )
      throw new Error(
        `stega.studioUrl must be a string or a function, received ${s.stega.studioUrl}`,
      )
    const a = typeof window < 'u' && location && location.hostname,
      f = a && h_(location.hostname)
    a && f && s.token && s.ignoreBrowserTokenWarning !== !0 ? a_() : typeof s.useCdn > 'u' && o_(),
      u && zb(s.projectId),
      s.dataset && Ch(s.dataset),
      'requestTagPrefix' in s &&
        (s.requestTagPrefix = s.requestTagPrefix
          ? xh(s.requestTagPrefix).replace(/\.+$/, '')
          : void 0),
      (s.apiVersion = `${s.apiVersion}`.replace(/^v/, '')),
      (s.isDefaultApi = s.apiHost === xi.apiHost),
      s.useCdn === !0 && s.withCredentials && s_(),
      (s.useCdn = s.useCdn !== !1 && !s.withCredentials),
      d_(s.apiVersion)
    const l = s.apiHost.split('://', 2),
      d = l[0],
      y = l[1],
      p = s.isDefaultApi ? f_ : y
    return (
      s.useProjectHostname
        ? ((s.url = `${d}://${s.projectId}.${y}/v${s.apiVersion}`),
          (s.cdnUrl = `${d}://${s.projectId}.${p}/v${s.apiVersion}`))
        : ((s.url = `${s.apiHost}/v${s.apiVersion}`), (s.cdnUrl = s.url)),
      s
    )
  },
...
function g_(r, e = {}) {
  ...
  s && (n.Authorization = `Bearer ${s}`),
    !e.useGlobalApi && !r.useProjectHostname && r.projectId && (n[p_] = r.projectId)
  const u = !!(typeof e.withCredentials > 'u' ? r.token || r.withCredentials : e.withCredentials),
    a = typeof e.timeout > 'u' ? r.timeout : e.timeout
...
const Hh = ({query: r, params: e = {}, options: n = {}}) => {
    const s = new URLSearchParams(),
      {tag: u, returnQuery: a, ...f} = n
    u && s.append('tag', u), s.append('query', r)
    for (const [l, d] of Object.entries(e)) s.append(`$${l}`, JSON.stringify(d))
    for (const [l, d] of Object.entries(f)) d && s.append(l, `${d}`)
    return a === !1 && s.append('returnQuery', 'false'), `?${s}`
  },
  v_ = (r, e) => (r === !1 ? void 0 : typeof r > 'u' ? e : r),
  m_ = (r = {}) => ({
    dryRun: r.dryRun,
    returnIds: !0,
  ...
  da = (r) => r.type === 'response',
  y_ = (r) => r.body,
  w_ = (r, e) => r.reduce((n, s) => ((n[e(s)] = s), n), /* @__PURE__ */ Object.create(null)),
  b_ = 11264
function Gh(r, e, n, s, u = {}, a = {}) {
  const f =
      'stega' in a
        ...
        : n,
    l = f.enabled ? Pb(u) : u,
    d = a.filterResponse === !1 ? (I) => I : (I) => I.result,
    {
      cache: y,
      next: p,
      ...m
    ...
    b = typeof y < 'u' || typeof p < 'u' ? {...m, fetch: {cache: y, next: p}} : m,
    C = Xr(r, e, 'query', {query: s, params: l}, b)
  return f.enabled
    ? C.pipe(
        yb(
          Ii(
...
function Xh(r, e, n, s) {
  return Xr(r, e, 'mutate', {mutations: [{delete: _h(n)}]}, s)
}
function Yh(r, e, n, s) {
  let u
  n instanceof Ai || n instanceof Ei
    ? (u = {patch: n.serialize()})
    : n instanceof kh || n instanceof qh
      ? (u = n.serialize())
      : (u = n)
  const a = Array.isArray(u) ? u : [u],
    f = (s && s.transactionId) || void 0
  return Xr(r, e, 'mutate', {mutations: a, transactionId: f}, s)
}
function Vh(r, e, n, s) {
  const u = Array.isArray(n) ? n : [n],
    a = (s && s.transactionId) || void 0,
    f = (s && s.skipCrossDatasetReferenceValidation) || void 0,
    l = (s && s.dryRun) || void 0
  return Xr(
    r,
    e,
...
function Xr(r, e, n, s, u = {}) {
  const a = n === 'mutate',
    ...
    p = y ? d : '',
    m = u.returnFirst,
    {timeout: b, token: C, tag: I, headers: O, returnQuery: R, lastLiveEventId: x} = u,
    D = mr(r, n, p),
    U = {
      method: y ? 'GET' : 'POST',
      uri: D,
  ...
  return Ti(r, e, U).pipe(
    ...
    Lt((M) => {
      if (!a) return M
      const z = M.results || []
      if (u.returnDocuments) return m ? z[0] && z[0].document : z.map((xt) => xt.document)
      const ht = m ? 'documentId' : 'documentIds',
        _t = m ? z[0] && z[0].id : z.map((xt) => xt.id)
      return {
...
function go(r, e, n, s, u = {}) {
  const a = {[s]: n},
    f = Object.assign({returnFirst: !0, returnDocuments: !0}, u)
...
function Ti(r, e, n) {
  ...
  const a = n.url || n.uri,
    ...
    l =
      typeof n.canUseCdn > 'u'
        ? ['GET', 'HEAD'].indexOf(n.method || 'GET') >= 0 && a.indexOf('/data/') === 0
        : n.canUseCdn
  let d = ((s = n.useCdn) != null ? s : f.useCdn) && l
  const y =
    n.tag && f.requestTagPrefix
      ? [f.requestTagPrefix, n.tag].join('.')
      : n.tag || f.requestTagPrefix
  if (
    (y && n.tag !== null && (n.query = {tag: xh(y), ...n.query}),
    ['GET', 'HEAD', 'POST'].indexOf(n.method || 'GET') >= 0 && a.indexOf('/data/query/') === 0)
  ) {
    ...
    typeof C == 'string' &&
      C !== 'raw' &&
      (Wh(C),
      (n.query = {perspective: C, ...n.query}),
      C === 'previewDrafts' && d && ((d = !1), u_())),
      n.lastLiveEventId && (n.query = {...n.query, lastLiveEventId: n.lastLiveEventId}),
  ...
  const p = g_(
    ...
    m = new Mt((b) => e(p, f.requester).subscribe(b))
...
function E_(r) {
  ...
  if (C_)
    return new DOMException(
      (e = r == null ? void 0 : r.reason) != null ? e : 'The operation was aborted.',
      'AbortError',
    )
  const s = new Error(
    (n = r == null ? void 0 : r.reason) != null ? n : 'The operation was aborted.',
  )
...
var Zh = (r, e, n) => {
  ...
  Zs = (r, e, n) => (Zh(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  Qs = (r, e, n) => {
    if (e.has(r)) throw TypeError('Cannot add the same private member more than once')
    e instanceof WeakSet ? e.add(r) : e.set(r, n)
  },
  to = (r, e, n, s) => (Zh(r, e, 'write to private field'), e.set(r, n), n),
  qs,
  Ws
class A_ {
  constructor(e, n) {
...
function Qh(r, e, n, s, u = {}) {
  ...
  const f = Ah(r.config()),
    ...
    d = S_(u, s),
    {tag: y, label: p, title: m, description: b, creditLine: C, filename: I, source: O} = d,
    R = {
      label: p,
      title: m,
      description: b,
  ...
  return (
    O && ((R.sourceId = O.id), (R.sourceName = O.name), (R.sourceUrl = O.url)),
    Ti(r, e, {
      tag: y,
      method: 'POST',
      timeout: d.timeout || 0,
...
var R_ = (r, e) =>
  Object.keys(e)
    ...
    .reduce((n, s) => ((n[s] = typeof r[s] > 'u' ? e[s] : r[s]), n), {})
const I_ = (r, e) => e.reduce((n, s) => (typeof r[s] > 'u' || (n[s] = r[s]), n), {}),
  O_ = 14800,
  T_ = ['includePreviousRevision', 'includeResult', 'visibility', 'effectFormat', 'tag'],
  L_ = {
    includeResult: !0,
  }
function td(r, e, n = {}) {
  const {url: s, token: u, withCredentials: a, requestTagPrefix: f} = this.config(),
    l = n.tag && f ? [f, n.tag].join('.') : n.tag,
    d = {...R_(n, L_), tag: l},
    y = I_(d, T_),
    p = Hh({query: r, params: e, options: {tag: l, ...y}}),
    m = `${s}${mr(this, 'listen', p)}`
  if (m.length > O_) return new Mt((O) => O.error(new Error('Query too large for listener')))
  const b = d.events ? d.events : ['mutation'],
    C = b.indexOf('reconnect') !== -1,
    I = {}
  return (
    (u || a) && (I.withCredentials = !0),
    u &&
      (I.headers = {
    ...
    new Mt((O) => {
      ...
      function M() {
        D ||
          (Te(),
          !D && R.readyState === R.CLOSED && (xt(), clearTimeout(x), (x = setTimeout(an, 100))))
      }
      function z(zt) {
        O.error($_(zt))
      }
      ...
      function xt() {
        R &&
          ...
          R.removeEventListener('channelError', z),
          R.removeEventListener('disconnect', _t),
          b.forEach((zt) => R.removeEventListener(zt, ht)),
          R.close())
      }
      function Te() {
      ...
      async function qe() {
        ...
        const Qt = new zt(m, I)
        return (
          Qt.addEventListener('error', M),
          Qt.addEventListener('channelError', z),
          Qt.addEventListener('disconnect', _t),
          b.forEach((yr) => Qt.addEventListener(yr, ht)),
          Qt
        )
      }
      function an() {
...
var nd = (r, e, n) => {
  ...
  Du = (r, e, n) => (nd(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  F_ = (r, e, n) => {
    if (e.has(r)) throw TypeError('Cannot add the same private member more than once')
    e instanceof WeakSet ? e.add(r) : e.set(r, n)
  },
...
class rd {
  ...
  events() {
    ...
    const n = mr(Du(this, kr), 'live/events'),
      s = new URL(Du(this, kr).getUrl(n, !1)),
      u = ['restart', 'message']
    return new Mt((a) => {
      let f,
        l,
      ...
      function b() {
        if (f) {
          ...
          for (const R of u) f.removeEventListener(R, m)
          f.close()
        }
      }
      async function C() {
        const R =
          typeof EventSource > 'u' ? (await Promise.resolve().then(() => Id)).default : EventSource
        if (y) return
        const x = new R(s.toString())
        x.addEventListener('error', p)
        for (const D of u) x.addEventListener(D, m)
        return x
      }
      function I() {
        C()
...
var id = (r, e, n) => {
  ...
  ie = (r, e, n) => (id(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  eo = (r, e, n) => {
    if (e.has(r)) throw TypeError('Cannot add the same private member more than once')
    e instanceof WeakSet ? e.add(r) : e.set(r, n)
  },
  no = (r, e, n, s) => (id(r, e, 'write to private field'), e.set(r, n), n),
  lr,
  hr
class D_ {
  constructor(e, n) {
...
class U_ {
   ...
   */
  create(e, n) {
    return Ht(jr(ie(this, dr), ie(this, pr), 'PUT', e, n))
  }
  /**
   * Edit a dataset with the given name
   *
   ...
   */
  edit(e, n) {
    return Ht(jr(ie(this, dr), ie(this, pr), 'PATCH', e, n))
  }
  /**
   * Delete a dataset with the given name
   *
   ...
   */
  list() {
    return Ht(Ze(ie(this, dr), ie(this, pr), {uri: '/datasets', tag: null}))
  }
}
...
var sd = (r, e, n) => {
  ...
  zn = (r, e, n) => (sd(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  ro = (r, e, n) => {
    if (e.has(r)) throw TypeError('Cannot add the same private member more than once')
    e instanceof WeakSet ? e.add(r) : e.set(r, n)
  },
  io = (r, e, n, s) => (sd(r, e, 'write to private field'), e.set(r, n), n),
  yi,
  wi
class k_ {
  constructor(e, n) {
...
class N_ {
   ...
   */
  getById(e) {
    return Ht(Ze(zn(this, bi), zn(this, _i), {uri: `/projects/${e}`}))
  }
}
...
var od = (r, e, n) => {
  ...
  so = (r, e, n) => (od(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  oo = (r, e, n) => {
    if (e.has(r)) throw TypeError('Cannot add the same private member more than once')
    e instanceof WeakSet ? e.add(r) : e.set(r, n)
  },
  uo = (r, e, n, s) => (od(r, e, 'write to private field'), e.set(r, n), n),
  Gs,
  js
class q_ {
  constructor(e, n) {
   ...
   */
  getById(e) {
    return Ze(so(this, Gs), so(this, js), {uri: `/users/${e}`})
  }
}
...
var B_ = Object.defineProperty,
  H_ = (r, e, n) =>
    e in r ? B_(r, e, {enumerable: !0, configurable: !0, writable: !0, value: n}) : (r[e] = n),
  Ie = (r, e, n) => (H_(r, typeof e != 'symbol' ? e + '' : e, n), n),
  ud = (r, e, n) => {
    if (!e.has(r)) throw TypeError('Cannot ' + n)
  },
  et = (r, e, n) => (ud(r, e, 'read from private field'), n ? n.call(r) : e.get(r)),
  ao = (r, e, n) => {
    if (e.has(r)) throw TypeError('Cannot add the same private member more than once')
    e instanceof WeakSet ? e.add(r) : e.set(r, n)
  },
  co = (r, e, n, s) => (ud(r, e, 'write to private field'), e.set(r, n), n),
  Wn,
  Bt
const G_ = class Qu {
  constructor(e, n = xi) {
    Ie(this, 'assets'),
      ...
      this.config(n),
      co(this, Bt, e),
      (this.assets = new A_(this, et(this, Bt))),
      (this.datasets = new D_(this, et(this, Bt))),
      (this.live = new rd(this)),
      (this.projects = new k_(this, et(this, Bt))),
      (this.users = new q_(this, et(this, Bt)))
  }
  /**
  ...
  fetch(e, n, s) {
    return Gh(this, et(this, Bt), et(this, Wn).stega, e, n, s)
  }
  /**
...
const z_ = class ta {
  constructor(e, n = xi) {
    Ie(this, 'assets'),
      ...
      this.config(n),
      co(this, Ut, e),
      (this.assets = new x_(this, et(this, Ut))),
      (this.datasets = new U_(this, et(this, Ut))),
      (this.live = new rd(this)),
      (this.projects = new N_(this, et(this, Ut))),
      (this.users = new W_(this, et(this, Ut))),
      (this.observable = new j_(e, n))
  }
  /**
   * Clone the client - returns a new instance
   */
  ...
  config(e) {
    if (e === void 0) return {...et(this, Bn)}
    if (et(this, Bn) && et(this, Bn).allowReconfigure === !1)
      throw new Error(
        'Existing client instance cannot be reconfigured - use `withConfig(newConfig)` to return a new client',
      )
    return (
      this.observable && this.observable.config(e), co(this, Bn, Bh(e, et(this, Bn) || {})), this
    )
  }
  /**
   * Clone the client with a new (partial) configuration.
  ...
  fetch(e, n, s) {
    return Ht(Gh(this, et(this, Ut), et(this, Bn).stega, e, n, s))
  }
  /**
   * Fetch a single document with the given ID.
   *
  ...
  create(e, n) {
    return Ht(go(this, et(this, Ut), e, 'create', n))
  }
  createIfNotExists(e, n) {
    return Ht(Kh(this, et(this, Ut), e, n))
  }
  createOrReplace(e, n) {
    return Ht(Jh(this, et(this, Ut), e, n))
  }
...
;(function (r, e) {
  ;(function () {
    var n,
      ...
      wa = Hd + Gd + jd,
      ba = '\\u2700-\\u27bf',
      _a = 'a-z\\xdf-\\xf6\\xf8-\\xff',
      zd = '\\xac\\xb1\\xd7\\xf7',
      Kd = '\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf',
      Jd = '\\u2000-\\u206f',
      Xd =
        ' \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000',
      Ca = 'A-Z\\xc0-\\xd6\\xd8-\\xde',
      Ea = '\\ufe0e\\ufe0f',
      Aa = zd + Kd + Jd + Xd,
      _o = "['’]",
      Yd = '[' + ki + ']',
      ...
      La = '(?:' + Ra + '|' + Ia + ')',
      Qd = '(?:' + _r + '|' + Ia + ')',
      $a = '(?:' + _o + '(?:d|ll|m|re|s|t|ve))?',
      Pa = '(?:' + _o + '(?:D|LL|M|RE|S|T|VE))?',
      Fa = Zd + '?',
      Ma = '[' + Ea + ']?',
      tp = '(?:' + Ta + '(?:' + [Oa, Eo, Ao].join('|') + ')' + Ma + Fa + ')*',
      ep = '\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])',
      np = '\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])',
      Da = Ma + Fa + tp,
      rp = '(?:' + [Vd, Eo, Ao].join('|') + ')' + Da,
      ip = '(?:' + [Oa + Ni + '?', Ni, Eo, Ao, Yd].join('|') + ')',
      sp = RegExp(_o, 'g'),
      op = RegExp(Ni, 'g'),
      xo = RegExp(Co + '(?=' + Co + ')|' + ip + Da, 'g'),
      up = RegExp(
        [
          _r + '?' + Ra + '+' + $a + '(?=' + [xa, _r, '$'].join('|') + ')',
          Qd + '+' + Pa + '(?=' + [xa, _r + La, '$'].join('|') + ')',
      ...
      lp = -1,
      At = {}
    ;(At[we] = At[ln] = At[Kt] = At[Nt] = At[oe] = At[tn] = At[Rn] = At[be] = At[In] = !0),
      (At[An] =
        At[wr] =
        At[V] =
        At[cn] =
    ...
    var hp = {
      ...
      vp = parseFloat,
      mp = parseInt,
      Ua = typeof Nr == 'object' && Nr && Nr.Object === Object && Nr,
      yp = typeof self == 'object' && self && self.Object === Object && self,
      Yt = Ua || yp || Function('return this')(),
      So = e && !e.nodeType && e,
      Zn = So && !0 && r && !r.nodeType && r,
      ka = Zn && Zn.exports === So,
      Ro = ka && Ua.process,
      Le = (function () {
        try {
      ...
      Na = Le && Le.isArrayBuffer,
      qa = Le && Le.isDate,
      Wa = Le && Le.isMap,
      Ba = Le && Le.isRegExp,
      Ha = Le && Le.isSet,
      Ga = Le && Le.isTypedArray
    function Ce(E, T, S) {
      switch (S.length) {
        case 0:
          return E.call(T)
    ...
    function ja(E, T) {
      for (var S = -1, B = E == null ? 0 : E.length; ++S < B; ) if (!T(E[S], S, E)) return !1
      return !0
    }
    function Tn(E, T) {
    ...
    function Io(E, T, S) {
      for (var B = -1, Z = E == null ? 0 : E.length; ++B < Z; ) if (S(T, E[B])) return !0
      return !1
    }
    function St(E, T) {
      for (var S = -1, B = E == null ? 0 : E.length, Z = Array(B); ++S < B; ) Z[S] = T(E[S], S, E)
      return Z
    }
    function Ln(E, T) {
      for (var S = -1, B = T.length, Z = E.length; ++S < B; ) E[Z + S] = T[S]
      return E
    }
    function Oo(E, T, S, B) {
      var Z = -1,
        dt = E == null ? 0 : E.length
      for (B && dt && (S = E[++Z]); ++Z < dt; ) S = T(S, E[Z], Z, E)
      return S
    }
    function _p(E, T, S, B) {
      var Z = E == null ? 0 : E.length
      for (B && Z && (S = E[--Z]); Z--; ) S = T(S, E[Z], Z, E)
      return S
    }
    function To(E, T) {
      for (var S = -1, B = E == null ? 0 : E.length; ++S < B; ) if (T(E[S], S, E)) return !0
      return !1
    }
    var Cp = Lo('length')
    function Ep(E) {
    ...
    function za(E, T, S) {
      var B
      return (
        S(E, function (Z, dt, qt) {
          if (T(Z, dt, qt)) return (B = dt), !1
        }),
        B
      )
    }
    ...
    function xp(E, T, S, B) {
      for (var Z = S - 1, dt = E.length; ++Z < dt; ) if (B(E[Z], T)) return Z
      return -1
    }
    function Ka(E) {
      return E !== E
    ...
    function Fo(E, T) {
      for (var S = -1, B = Array(E); ++S < E; ) B[S] = T(S)
      return B
    }
    function Rp(E, T) {
    ...
    function Ip(E, T) {
      for (var S = E.length, B = 0; S--; ) E[S] === T && ++B
      return B
    }
    var Op = $o(hp),
      Tp = $o(dp)
    ...
    function Dp(E, T, S) {
      for (var B = S - 1, Z = E.length; ++B < Z; ) if (E[B] === T) return B
      return -1
    }
    function Up(E, T, S) {
      for (var B = S + 1; B--; ) if (E[B] === T) return B
      return B
    }
    function Ar(E) {
    ...
    var kp = $o(pp)
    function Np(E) {
      for (var T = (xo.lastIndex = 0); xo.test(E); ) ++T
      return T
    }
    function qp(E) {
      return E.match(xo) || []
    ...
    var Bp = function E(T) {
        ...
        var S = T.Array,
          ...
          Pn = T.Symbol,
          Ji = T.Uint8Array,
          nc = Ki ? Ki.allocUnsafe : n,
          Xi = Qa(wt.getPrototypeOf, wt),
          rc = wt.create,
          ic = Sr.propertyIsEnumerable,
          Yi = Hi.splice,
          sc = Pn ? Pn.isConcatSpreadable : n,
          ei = Pn ? Pn.iterator : n,
          Qn = Pn ? Pn.toStringTag : n,
          Vi = (function () {
            try {
          ...
          Xp = T.clearTimeout !== Yt.clearTimeout && T.clearTimeout,
          Yp = B && B.now !== Yt.Date.now && B.now,
          Vp = T.setTimeout !== Yt.setTimeout && T.setTimeout,
          Zi = qt.ceil,
          Qi = qt.floor,
          ko = wt.getOwnPropertySymbols,
          Zp = Ki ? Ki.isBuffer : n,
          oc = T.isFinite,
          Qp = Hi.join,
          tg = Qa(wt.keys, wt),
          ...
          ug = sr(Rr),
          ag = sr(ri),
          es = Pn ? Pn.prototype : n,
          si = es ? es.valueOf : n,
          ac = es ? es.toString : n
        function g(t) {
          if (Tt(t) && !tt(t) && !(t instanceof at)) {
            if (t instanceof Fe) return t
            if (vt.call(t, '__wrapped__')) return ff(t)
          }
          return new Fe(t)
        }
        var Or = (function () {
        ...
        function lg() {
          var t = this.__wrapped__.value(),
            ...
            F = P.length,
            q = 0,
            j = ne(A, this.__takeCount__)
          if (!o || (!c && h == A && j == A)) return $c(t, this.__actions__)
          var J = []
          t: for (; A-- && q < j; ) {
            $ += i
        ...
        ;(tr.prototype.clear = hg),
          (tr.prototype.delete = dg),
          (tr.prototype.get = pg),
          (tr.prototype.has = gg),
          (tr.prototype.set = vg)
        function dn(t) {
        ...
        ;(dn.prototype.clear = mg),
          (dn.prototype.delete = yg),
          (dn.prototype.get = wg),
          (dn.prototype.has = bg),
          (dn.prototype.set = _g)
        function pn(t) {
        ...
        function er(t) {
          var i = -1,
            o = t == null ? 0 : t.length
          for (this.__data__ = new pn(); ++i < o; ) this.add(t[i])
        }
        function Rg(t) {
        ...
        function Pg(t, i) {
          ...
          if (o instanceof dn) {
            var c = o.__data__
            if (!ni || c.length < u - 1) return c.push([t, i]), (this.size = ++o.size), this
            o = this.__data__ = new pn(c)
          }
          return o.set(t, i), (this.size = o.size), this
        }
        ;(Ge.prototype.clear = Og),
          (Ge.prototype.delete = Tg),
          (Ge.prototype.get = Lg),
          (Ge.prototype.has = $g),
          (Ge.prototype.set = Pg)
        function cc(t, i) {
        ...
        function rs(t, i) {
          for (var o = t.length; o--; ) if (je(t[o][0], i)) return o
          return -1
        }
        function Dg(t, i, o, c) {
          return (
        ...
        function Me(t, i, o, c, h, v) {
          var w,
            ...
            A = i & b,
            $ = i & C
          if ((o && (w = h ? o(t, c, h, v) : o(t)), w !== n)) return w
          if (!It(t)) return t
          var P = tt(t)
          if (P) {
            if (((w = x0(t)), !_)) return he(t, w)
          } else {
            var F = re(t),
              q = F == br || F == Pi
            if (kn(t)) return Mc(t, _)
            if (F == k || F == An || (q && !h)) {
              if (((w = A || q ? {} : tf(t)), !_)) return A ? p0(t, Ug(w, t)) : d0(t, lc(w, t))
            } else {
              if (!Ct[F]) return h ? t : {}
              w = S0(t, F, _)
            }
          ...
          v.set(t, w),
            Tf(t)
              ...
              : If(t) &&
                t.forEach(function (X, ot) {
                  w.set(ot, Me(X, i, o, ot, t, v))
                })
          var J = $ ? (A ? au : uu) : A ? pe : Gt,
            rt = P ? n : J(t)
          return (
            $e(rt || t, function (X, ot) {
        ...
        function hc(t, i, o) {
          ...
          for (t = wt(t); c--; ) {
            var h = o[c],
              v = i[h],
              w = t[h]
            if ((w === n && !(h in t)) || !v(w)) return !1
          }
          return !0
        }
        function dc(t, i, o) {
          if (typeof t != 'function') throw new Pe(f)
          return di(function () {
            t.apply(n, o)
          }, i)
        }
        function ui(t, i, o, c) {
          ...
          if (!_) return A
          o && (i = St(i, Ee(o))),
            c ? ((v = Io), (w = !1)) : i.length >= u && ((v = ti), (w = !1), (i = new er(i)))
          t: for (; ++h < _; ) {
            var P = t[h],
              F = o == null ? P : o(P)
            if (((P = c || P !== 0 ? P : 0), w && F === F)) {
              for (var q = $; q--; ) if (i[q] === F) continue t
              A.push(P)
            } else v(i, F, c) || A.push(P)
          }
          return A
        }
        var Fn = qc(en),
        ...
        function rr(t, i) {
          i = Dn(i, t)
          for (var o = 0, c = i.length; t != null && o < c; ) t = t[rn(i[o++])]
          return o && o == c ? t : n
        }
        function mc(t, i, o) {
          var c = i(t)
        ...
        function zo(t, i, o) {
          for (
            var c = o ? Io : qi, h = t[0].length, v = t.length, w = v, _ = S(v), A = 1 / 0, $ = [];
            w--;
            ...
            w && i && (P = St(P, Ee(i))),
              (A = ne(P.length, A)),
              (_[w] = !o && (i || (h >= 120 && P.length >= 120)) ? new er(w && P) : n)
          }
          P = t[0]
          var F = -1,
            q = _[0]
          t: for (; ++F < h && $.length < A; ) {
            ...
            if (((j = o || j !== 0 ? j : 0), !(q ? ti(q, J) : c($, J, o)))) {
              for (w = v; --w; ) {
                var rt = _[w]
                if (!(rt ? ti(rt, J) : c(t[w], J, o))) continue t
              }
              q && q.push(J), $.push(j)
            }
          }
        ...
        function Kg(t, i, o, c, h, v) {
          ...
          if (!(o & I)) {
            var j = P && vt.call(t, '__wrapped__'),
              J = F && vt.call(i, '__wrapped__')
            if (j || J) {
              var rt = j ? t.value() : t,
                X = J ? i.value() : i
        ...
        function Ko(t, i, o, c) {
          ...
          for (t = wt(t); h--; ) {
            var _ = o[h]
            if (w && _[2] ? _[1] !== t[_[0]] : !(_[0] in t)) return !1
          }
          for (; ++h < v; ) {
            _ = o[h]
            var A = _[0],
              ...
              P = _[1]
            if (w && _[2]) {
              if ($ === n && !(A in t)) return !1
            } else {
              var F = new Ge()
              if (c) var q = c($, P, A, t, i, F)
              if (!(q === n ? ci(P, $, I | O, c, F) : q)) return !1
            }
          }
          return !0
        }
        function wc(t) {
          if (!It(t) || T0(t)) return !1
          var i = wn(t) ? Jp : kd
          return i.test(sr(t))
        }
        function Xg(t) {
        ...
        function Jo(t) {
          if (!hi(t)) return tg(t)
          var i = []
          for (var o in wt(t)) vt.call(t, o) && o != 'constructor' && i.push(o)
          return i
        }
        function Zg(t) {
          if (!It(t)) return F0(t)
          var i = hi(t),
            o = []
          for (var c in t) (c == 'constructor' && (i || !vt.call(t, c))) || o.push(c)
          return o
        }
        function Xo(t, i) {
          return t < i
        ...
        function os(t, i, o, c, h) {
          t !== i &&
            Ho(
              i,
              function (v, w) {
                if ((h || (h = new Ge()), It(v))) Qg(t, i, w, o, os, c, h)
                else {
                  ...
                  : Pt(_)
                    ...
                    : j
                      ...
                      : J
                        ...
                        : (P = [])
                : pi(A) || or(A)
                  ? ((P = _), or(_) ? (P = Pf(_)) : (!It(_) || wn(_)) && (P = tf(A)))
                  : (F = !1)
          }
        ...
        function Ac(t, i) {
          var o = t.length
          if (o) return (i += i < 0 ? o : 0), yn(i, o) ? t[i] : n
        }
        function xc(t, i, o) {
          i.length
            ? (i = St(i, function (v) {
        ...
        function Zo(t, i) {
          var o = ''
          if (!t || i < 1 || i > se) return o
          do i % 2 && (o += t), (i = Qi(i / 2)), i && (t += t)
          while (i)
          return o
        }
        function st(t, i) {
        ...
        function Ae(t) {
          ...
          if (tt(t)) return St(t, Ae) + ''
          if (xe(t)) return ac ? ac.call(t) : ''
          var i = t + ''
        ...
        function Mn(t, i, o) {
          ...
          t: for (; ++c < v; ) {
            ...
            if (((P = o || P !== 0 ? P : 0), w && F === F)) {
              for (var q = A.length; q--; ) if (A[q] === F) continue t
              i && A.push(F), _.push(P)
            } else h(A, F, o) || (A !== _ && A.push(F), _.push(P))
          }
          return _
        }
        function tu(t, i) {
        ...
        function eu(t, i, o) {
          var c = t.length
          if (c < 2) return c ? Mn(t[0]) : []
          for (var h = -1, v = S(c); ++h < c; )
            for (var w = t[h], _ = -1; ++_ < c; ) _ != h && (v[h] = ui(v[h] || w, t[_], i, o))
        ...
        function Nc(t, i, o, c) {
          for (
            ...
            F[h] = t[h]
          for (var j = h; ++A < $; ) F[j + A] = i[A]
          for (; ++w < _; ) (q || h < v) && (F[j + o[w]] = t[h++])
          return F
        }
        function he(t, i) {
          var o = -1,
            c = t.length
          for (i || (i = S(c)); ++o < c; ) i[o] = t[o]
          return i
        }
        function nn(t, i, o, c) {
          var h = !o
        ...
        function Tr(t) {
          return st(function (i, o) {
            var c = -1,
              ...
              w = h > 2 ? o[2] : n
            for (
              v = t.length > 3 && typeof v == 'function' ? (h--, v) : n,
                w && fe(o[0], o[1], w) && ((v = h < 3 ? n : v), (h = 1)),
                i = wt(i);
              ++c < h;
        ...
        function qc(t, i) {
          return function (o, c) {
            if (o == null) return o
            if (!de(o)) return t(o, c)
            for (
              var h = o.length, v = i ? h : -1, w = wt(o);
              (i ? v-- : ++v < h) && c(w[v], v, w) !== !1;
        ...
        function v0(t, i, o) {
          var c = li(t)
          function h() {
            for (var v = arguments.length, w = S(v), _ = v, A = $r(h); _--; ) w[_] = arguments[_]
            var $ = v < 3 && w[0] !== A && w[v - 1] !== A ? [] : $n(w, A)
            if (((v -= $.length), v < o)) return Kc(t, i, fs, h.placeholder, n, w, $, n, n, o - v)
        ...
        function Gc(t) {
          return mn(function (i) {
            ...
            for (t && i.reverse(); c--; ) {
              var v = i[c]
              if (typeof v != 'function') throw new Pe(f)
              if (h && !w && ps(v) == 'wrapper') var w = new Fe([], !0)
            }
            for (c = w ? c : o; ++c < o; ) {
              v = i[c]
              var _ = ps(v),
                A = _ == 'wrapper' ? cu(v) : n
              A && du(A[0]) && A[1] == (_t | U | z | xt) && !A[4].length && A[9] == 1
                ? (w = w[ps(A[0])].apply(w, A[3]))
                : (w = v.length == 1 && du(v) ? w[_]() : w.thru(v))
            }
            return function () {
              var $ = arguments,
                P = $[0]
              if (w && $.length == 1 && tt(P)) return w.plant(P).value()
              for (var F = 0, q = o ? i[F].apply(this, $) : P; ++F < o; ) q = i[F].call(this, q)
              return q
            }
          })
        }
        function fs(t, i, o, c, h, v, w, _, A, $) {
          var P = i & _t,
            ...
            rt = q ? n : li(t)
          function X() {
            for (var ot = arguments.length, lt = S(ot), Se = ot; Se--; ) lt[Se] = arguments[Se]
            if (j)
              var le = $r(X),
                Re = Ip(lt, le)
            if (
              (c && (lt = kc(lt, c, h, j)), v && (lt = Nc(lt, v, w, j)), (ot -= Re), j && ot < $)
            ) {
              var Ft = $n(lt, le)
              return Kc(t, i, fs, X.placeholder, o, lt, Ft, _, A, $ - ot)
            }
            var ze = F ? o : this,
              _n = q ? ze[t] : t
            return (
              (ot = lt.length),
              _ ? (lt = D0(lt, _)) : J && ot > 1 && lt.reverse(),
              P && A < ot && (lt.length = A),
              this && this !== Yt && this instanceof X && (_n = rt || li(_n)),
              _n.apply(ze, lt)
            )
          }
          return X
          ...
          function w() {
            for (
              var _ = -1,
                ...
                P = c.length,
                F = S(P + A),
                q = this && this !== Yt && this instanceof w ? v : t;
              ++$ < P;
        ...
        function zc(t) {
          return function (i, o, c) {
            return (
              c && typeof c != 'number' && fe(i, o, c) && (o = c = n),
              (i = bn(i)),
              o === n ? ((o = i), (i = 0)) : (o = bn(o)),
              (c = c === n ? (i < o ? 1 : -1) : bn(c)),
              n0(i, o, c, t)
        ...
        function ds(t) {
          return function (i, o) {
            return (
              (typeof i == 'string' && typeof o == 'string') || ((i = ke(i)), (o = ke(o))), t(i, o)
            )
          }
        }
        ...
        function vn(t, i, o, c, h, v, w, _) {
          var A = i & x
          if (!A && typeof t != 'function') throw new Pe(f)
          var $ = c ? c.length : 0
          if (
            ($ || ((i &= ~(z | ht)), (c = h = n)),
            (w = w === n ? w : Wt(nt(w), 0)),
          ...
          if (
            ...
            (c = j[3]),
            (h = j[4]),
            (_ = j[9] = j[9] === n ? (A ? 0 : t.length) : Wt(j[9] - $, 0)),
            !_ && i & (U | M) && (i &= ~(U | M)),
            !i || i == R)
          )
            var J = g0(t, i, o)
        ...
        function Vc(t, i, o, c, h, v) {
          ...
          for (v.set(t, i), v.set(i, t); ++F < _; ) {
            var J = t[F],
              rt = i[F]
            if (c) var X = w ? c(rt, J, F, i, t, v) : c(J, rt, F, t, i, v)
            if (X !== n) {
              if (X) continue
              q = !1
              break
            ...
            if (j) {
              if (
                !To(i, function (ot, lt) {
                  if (!ti(j, lt) && (J === ot || h(J, ot, o, c, v))) return j.push(lt)
                })
              ) {
                q = !1
                break
        ...
        function b0(t, i, o, c, h, v, w) {
          switch (o) {
            ...
            case G:
              var A = c & I
              if ((_ || (_ = Bi), t.size != i.size && !A)) return !1
              var $ = w.get(t)
              if ($) return $ == i
              ;(c |= O), w.set(t, i)
              ...
              return w.delete(t), P
            case mt:
              if (si) return si.call(t) == si.call(i)
          }
          return !1
        }
        function _0(t, i, o, c, h, v) {
          ...
          for (var F = A; F--; ) {
            var q = _[F]
            if (!(w ? q in i : vt.call(i, q))) return !1
          }
          var j = v.get(t),
            J = v.get(i)
          if (j && J) return j == i && J == t
          var rt = !0
          v.set(t, i), v.set(i, t)
          for (var X = w; ++F < A; ) {
            q = _[F]
            var ot = t[q],
              lt = i[q]
            if (c) var Se = w ? c(lt, ot, q, i, t, v) : c(ot, lt, q, t, i, v)
        ...
        var lu = ko
          ...
          Zc = ko
            ? function (t) {
                for (var i = []; t; ) Ln(i, lu(t)), (t = Xi(t))
                return i
              }
            : Ou,
          re = ce
        ;((No && re(new No(new ArrayBuffer(1))) != pt) ||
          (ni && re(new ni()) != ye) ||
          (qo && re(qo.resolve()) != H) ||
          (Rr && re(new Rr()) != G) ||
          (ri && re(new ri()) != ft)) &&
        ...
        function Qc(t, i, o) {
          ...
          for (var c = -1, h = i.length, v = !1; ++c < h; ) {
            var w = rn(i[c])
            if (!(v = t != null && o(t, w))) break
            t = t[w]
          }
          return v || ++c != h
            ? v
            : ((h = t == null ? 0 : t.length), !!h && Cs(h) && yn(w, h) && (tt(t) || or(t)))
        }
        function x0(t) {
          var i = t.length,
...
`,
        ...
        function yn(t, i) {
          ...
          return (
            (i = i ?? se),
            !!i && (o == 'number' || (o != 'symbol' && qd.test(t))) && t > -1 && t % 1 == 0 && t < i
          )
        }
        function fe(t, i, o) {
          if (!It(o)) return !1
          var c = typeof i
          return (c == 'number' ? de(o) && yn(i, o.length) : c == 'string' && i in o)
            ? je(o[i], t)
            : !1
        }
        function hu(t, i) {
          if (tt(t)) return !1
          var o = typeof t
          return o == 'number' || o == 'symbol' || o == 'boolean' || t == null || xe(t)
            ? !0
            : ae.test(t) || !ue.test(t) || (i != null && t in wt(i))
        }
        function O0(t) {
          var i = typeof t
        ...
        function du(t) {
          var i = ps(t),
            o = g[i]
          if (typeof o != 'function' || !(i in at.prototype)) return !1
          if (t === o) return !0
          var c = cu(o)
          return !!c && t === c[0]
        }
        ...
        function hi(t) {
          var i = t && t.constructor,
            o = (typeof i == 'function' && i.prototype) || Sr
          return t === o
        }
        function ef(t) {
          return t === t && !It(t)
        ...
        function P0(t, i) {
          var o = t[1],
            ...
            w =
              (c == _t && o == U) ||
              (c == _t && o == xt && t[7].length <= i[8]) ||
              (c == (_t | xt) && i[7].length <= i[8] && o == U)
          if (!(v || w)) return t
          ...
          return (
            (_ = i[5]),
            _ && ((A = t[5]), (t[5] = A ? Nc(A, _, i[6]) : _), (t[6] = A ? $n(t[5], p) : i[6])),
            (_ = i[7]),
            _ && (t[7] = _),
            c & _t && (t[8] = t[8] == null ? i[8] : ne(t[8], i[8])),
            t[9] == null && (t[9] = i[9]),
            (t[0] = i[0]),
            (t[1] = h),
            t
        ...
        function F0(t) {
          var i = []
          if (t != null) for (var o in wt(t)) i.push(o)
          return i
        }
        function M0(t) {
          return zi.call(t)
        ...
        function rn(t) {
          if (typeof t == 'string' || xe(t)) return t
          var i = t + ''
          return i == '0' && 1 / t == -te ? '-0' : i
        }
        function sr(t) {
        ...
        function ff(t) {
          ...
          return (
            (i.__actions__ = he(t.__actions__)),
        ...
        function k0(t, i, o) {
          ...
          if (!c || i < 1) return []
          for (var h = 0, v = 0, w = S(Zi(c / i)); h < c; ) w[v++] = De(t, h, (h += i))
          return w
        }
        function N0(t) {
        ...
        function q0() {
          ...
          if (!t) return []
          for (var i = S(t - 1), o = arguments[0], c = t; c--; ) i[c - 1] = arguments[c]
        ...
        function J0(t, i, o, c) {
          ...
          return h
            ? (o && typeof o != 'number' && fe(t, i, o) && ((o = 0), (c = h)), qg(t, i, o, c))
            : []
        }
        function lf(t, i, o) {
          var c = t == null ? 0 : t.length
        ...
        function hf(t, i, o) {
          ...
          var h = c - 1
          return (
            o !== n && ((h = nt(o)), (h = o < 0 ? Wt(c + h, 0) : ne(h, c - 1))),
            Wi(t, K(i, 3), h, !0)
          )
        }
        function df(t) {
        ...
        function iv(t, i, o) {
          ...
          var h = c
          return (
            o !== n && ((h = nt(o)), (h = h < 0 ? Wt(c + h, 0) : ne(h, c - 1))),
            i === i ? Up(t, i, h) : Wi(t, Ka, h, !0)
          )
        }
        function sv(t, i) {
        ...
        function lv(t, i, o) {
          var c = t == null ? 0 : t.length
          return c
            ? (o && typeof o != 'number' && fe(t, i, o)
                ? ((i = 0), (o = c))
                : ((i = i == null ? 0 : nt(i)), (o = o === n ? c : nt(o))),
              De(t, i, o))
            : []
        }
        function hv(t, i) {
        ...
        function mu(t) {
          ...
          return (
            (t = Tn(t, function (o) {
              if (Pt(o)) return (i = Wt(o.length, i)), !0
            })),
            Fo(i, function (o) {
              return St(t, Lo(o))
            })
        ...
        var qv = mn(function (t) {
          ...
          return i > 1 || this.__actions__.length || !(c instanceof at) || !yn(o)
            ? this.thru(h)
            : ((c = c.slice(o, +o + (i ? 1 : 0))),
              c.__actions__.push({
                func: ms,
        ...
        function zv() {
          ...
          if (t instanceof at) {
            var i = t
            return (
              this.__actions__.length && (i = new at(this)),
              (i = i.reverse()),
              i.__actions__.push({
                func: ms,
                args: [vu],
        ...
        function rm(t, i, o, c) {
          ...
          return (
            o < 0 && (o = Wt(h + o, 0)),
            Es(t) ? o <= h && t.indexOf(i, o) > -1 : !!h && Cr(t, i, o) > -1
          )
        }
        ...
        function pm(t) {
          if (t == null) return 0
          if (de(t)) return Es(t) ? Ar(t) : t.length
          var i = re(t)
        ...
        var vm = st(function (t, i) {
            ...
            var o = i.length
            return (
              o > 1 && fe(t, i[0], i[1]) ? (i = []) : o > 2 && fe(i[0], i[1], i[2]) && (i = [i[0]]),
              xc(t, Vt(i, 1), [])
            )
          }),
          ws =
        ...
        function mm(t, i) {
          if (typeof i != 'function') throw new Pe(f)
          return (
            (t = nt(t)),
            function () {
        ...
        function xf(t, i, o) {
          ...
          function Re() {
            ...
            if (((c = arguments), (h = this), (A = Ft), ze)) {
              if (_ === n) return J(A)
              if (F) return Fc(_), (_ = di(ot, i)), j(A)
            }
        ...
        function bs(t, i) {
          if (typeof t != 'function' || (i != null && typeof i != 'function')) throw new Pe(f)
          var o = function () {
            var c = arguments,
        ...
        var Cm = a0(function (t, i) {
            ...
            return st(function (c) {
              for (var h = -1, v = ne(c.length, o); ++h < v; ) c[h] = i[h].call(this, c[h])
              return Ce(t, this, c)
            })
          }),
          wu = st(function (t, i) {
        ...
        function Sm(t, i, o) {
          ...
          return (
            It(o) &&
              ((c = 'leading' in o ? !!o.leading : c), (h = 'trailing' in o ? !!o.trailing : h)),
            xf(t, i, {
              leading: c,
              maxWait: i,
              trailing: h,
        ...
        function Wm(t) {
          ...
          if (
            ...
            return !t.length
          var i = re(t)
          if (i == ye || i == G) return !t.size
          if (hi(t)) return !Jo(t).length
          for (var o in t) if (vt.call(t, o)) return !1
          return !0
        }
        function Bm(t, i) {
          return ci(t, i)
        ...
        function bu(t) {
          ...
          return (
            i == ee ||
            i == xn ||
            (typeof t.message == 'string' && typeof t.name == 'string' && !pi(t))
          )
        }
        function Gm(t) {
        ...
        function Lf(t) {
          if (!t) return []
          if (de(t)) return Es(t) ? He(t) : he(t)
          if (ei && t[ei]) return Fp(t[ei]())
          var i = re(t),
            o = i == ye ? Do : i == G ? Bi : Fr
          return o(t)
        }
        ...
        var iy = Tr(function (t, i) {
            ...
            for (var o in i) vt.call(i, o) && oi(t, o, i[o])
          }),
          Ff = Tr(function (t, i) {
            nn(i, pe(i), t)
          }),
        ...
        var wy = jc(function (t, i, o) {
          ...
          by = jc(function (t, i, o) {
            i != null && typeof i.toString != 'function' && (i = zi.call(i)),
              vt.call(t, i) ? t[i].push(o) : (t[i] = [o])
          }, K),
          _y = st(ai)
        function Gt(t) {
        ...
        function Dy(t, i, o) {
          return (
            o === n && ((o = i), (i = n)),
            o !== n && ((o = ke(o)), (o = o === o ? o : 0)),
            i !== n && ((i = ke(i)), (i = i === i ? i : 0)),
            nr(ke(t), i, o)
          )
        }
        function Uy(t, i, o) {
        ...
        function ky(t, i, o) {
          if (
            (o && typeof o != 'boolean' && fe(t, i, o) && (i = o = n),
            o === n &&
              (typeof i == 'boolean'
                ? ((o = i), (i = n))
                : typeof t == 'boolean' && ((o = t), (t = n))),
            t === n && i === n
              ? ((t = 0), (i = 1))
              : ((t = bn(t)), i === n ? ((i = t), (t = 0)) : (i = bn(i))),
            t > i)
          ) {
            var c = t
            ;(t = i), (i = c)
        ...
        function Qy(t, i, o) {
          return (
            o && typeof o != 'number' && fe(t, i, o) && (i = o = n),
            (o = o === n ? kt : o >>> 0),
            o
              ? ((t = gt(t)),
                t && (typeof i == 'string' || (i != null && !_u(i))) && ((i = Ae(i)), !i && Er(t))
                  ? Un(He(t), 0, o)
                  : t.split(i, o))
              : []
          )
        ...
        function n1(t, i, o) {
          ...
          var h = As({}, i.imports, c.imports, Xc),
            v = Gt(h),
            w = Mo(h, v),
            _,
            A,
            ...
            j =
              ...
              (vt.call(i, 'sourceURL')
                ...
                : 'lodash.templateSources[' + ++lp + ']') +
              `
`
          t.replace(q, function (X, ot, lt, Se, le, Re) {
            return (
              lt || (lt = Se),
              (F += t.slice($, Re).replace(Bd, Lp)),
              ot &&
                ((_ = !0),
                (F +=
                  `' +
...
`
          else if (Pd.test(J)) throw new Z(l)
          ;(F = (A ? F.replace(Jt, '') : F).replace(Zr, '$1').replace(hn, '$1;')),
            (F =
              'function(' +
              (J || 'obj') +
              `) {
...
`) +
        ...
        function s1(t, i, o) {
          if (((t = gt(t)), t && (o || i === n))) return Ya(t)
          if (!t || !(i = Ae(i))) return t
          var c = He(t),
            h = He(i),
            v = Va(c, h),
            w = Za(c, h) + 1
        ...
        function o1(t, i, o) {
          if (((t = gt(t)), t && (o || i === n))) return t.slice(0, tc(t) + 1)
          if (!t || !(i = Ae(i))) return t
          var c = He(t),
            h = Za(c, He(i)) + 1
        ...
        function u1(t, i, o) {
          if (((t = gt(t)), t && (o || i === n))) return t.replace(_e, '')
          if (!t || !(i = Ae(i))) return t
          var c = He(t),
            h = Va(c, He(i))
          return Un(c, h).join('')
          ...
          if ((w && (_ += A.length - _), _u(h))) {
            if (t.slice(_).search(h)) {
              var $,
                P = A
              for (
                h.global || (h = Uo(h.source, gt(ya.exec(h)) + 'g')), h.lastIndex = 0;
                ($ = h.exec(P));
        ...
        function h1(t) {
          ...
          return (
            (t = i
              ? St(t, function (c) {
                  if (typeof c[1] != 'function') throw new Pe(f)
                  return [o(c[0]), c[1]]
                })
              : []),
            st(function (c) {
              for (var h = -1; ++h < i; ) {
                var v = t[h]
                if (Ce(v[0], this, c)) return Ce(v[1], this, c)
              }
            })
          )
        }
        ...
        function Ru(t, i, o) {
          var c = Gt(i),
            h = ss(i, c)
          o == null &&
            !(It(i) && (h.length || !c.length)) &&
            ((o = i), (i = t), (t = this), (h = ss(i, Gt(i))))
          var v = !(It(o) && 'chain' in o) || !!o.chain,
            w = wn(t)
          return (
            $e(h, function (_) {
              var A = i[_]
              ;(t[_] = A),
                w &&
                  (t.prototype[_] = function () {
                    var $ = this.__chain__
                    if (v || $) {
                      var P = t(this.__wrapped__),
                        F = (P.__actions__ = he(this.__actions__))
        ...
        function $1(t, i) {
          if (((t = nt(t)), t < 1 || t > se)) return []
          var o = kt,
            c = ne(t, kt)
          ;(i = K(i)), (t -= kt)
          for (var h = Fo(c, i); ++o < t; ) i(o)
          return h
        }
        function P1(t) {
        ...
        return (
          ...
          (g.sortedIndexBy = dv),
          (g.sortedIndexOf = pv),
          (g.sortedLastIndex = gv),
          (g.sortedLastIndexBy = vv),
          (g.sortedLastIndexOf = mv),
          (g.startCase = t1),
          (g.startsWith = e1),
          (g.subtract = K1),
          (g.sum = J1),
          ...
          $e(['drop', 'take'], function (t, i) {
            ;(at.prototype[t] = function (o) {
              ...
              return (
                c.__filtered__
                  ? (c.__takeCount__ = ne(o, c.__takeCount__))
                  : c.__views__.push({
                      size: ne(o, kt),
          ...
          (at.prototype.slice = function (t, i) {
            ...
            return o.__filtered__ && (t > 0 || i < 0)
              ...
              : (t < 0 ? (o = o.takeRight(-t)) : t && (o = o.drop(t)),
                i !== n && ((i = nt(i)), (o = i < 0 ? o.dropRight(-i) : o.take(i - t))),
                o)
          }),
          ...
          en(at.prototype, function (t, i) {
            ...
            h &&
              (g.prototype[i] = function () {
                ...
                return J && rt
                  ? t.apply(this, _)
                  : ((X = this.thru(F)), J ? (c ? X.value()[0] : X.value()) : X)
              })
          }),
          ...
          (at.prototype.clone = cg),
          (at.prototype.reverse = fg),
          (at.prototype.value = lg),
          (g.prototype.at = qv),
          (g.prototype.chain = Wv),
          (g.prototype.commit = Bv),
          (g.prototype.next = Hv),
          (g.prototype.plant = jv),
          (g.prototype.reverse = zv),
          (g.prototype.toJSON = g.prototype.valueOf = g.prototype.value = Kv),
          (g.prototype.first = g.prototype.head),
          ei && (g.prototype[ei] = Gv),
          g
        )
      },
      xr = Bp()
...
var eC = ea.exports
const nC = /* @__PURE__ */ ad(eC),
  ct = nC('mutator-document')
class sn {
  constructor(e, n) {
    W(this, '_value')
    W(this, 'path')
  ...
  getIndex(e) {
    return Array.isArray(this._value)
      ? e >= this.length()
        ? null
        : new sn(this._value[e], this.path.concat(e))
      : !1
  }
  // Object reader
  hasAttribute(e) {
  ...
  getAttribute(e) {
    if (!gi(this._value)) throw new Error('getAttribute only applies to plain objects')
  ...
  setIndex(e, n) {
    ...
    if (Object.is(n, this._value[e])) return this
  ...
  unsetIndices(e) {
    ...
    const n = this._value.length,
      s = []
    for (let u = 0; u < n; u++) e.indexOf(u) === -1 && s.push(this._value[u])
  ...
  insertItemsAt(e, n) {
    ...
    let s
    return (
      this._value.length === 0 && e === 0
        ? (s = n)
        : (s = this._value.slice(0, e).concat(n).concat(this._value.slice(e))),
      new sn(s, this.path)
    )
  }
  // Object writer interface
  setAttribute(e, n) {
    if (!gi(this._value)) throw new Error('Unable to set attribute of non-object container')
    if (Object.is(n, this._value[e])) return this
  ...
  unsetAttribute(e) {
    if (!gi(this._value)) throw new Error('Unable to unset attribute of non-object container')
...
function uC(r) {
  const [e, n] = cd(r)
  if (!e) throw new Error('Head cannot be null')
  return cC(e, n)
}
function cd(r) {
  if (r.type !== 'path') return [r, null]
  const e = r.nodes
  return e.length === 0
    ? [null, null]
    : e.length === 1
      ? [e[0], null]
      : [e[0], {type: 'path', nodes: e.slice(1)}]
}
function aC(r, e) {
  if (!r && !e) return null
  const n = r ? r.nodes : [],
...
class dC {
  ...
  consume(e) {
    if (this.i + e.length > this.length) throw new Error(`Expected ${e} at end of jsonpath`)
    if (e === this.source.slice(this.i, this.i + e.length)) this.i += e.length
    else throw new Error(`Expected "${e}", but source contained "${this.source.slice()}`)
  }
  ...
  // happens.
  tryConsume(e) {
    if (this.i + e.length > this.length) return null
  ...
  tokenizeQuoted() {
    ...
    if (e === "'" || e === '"') {
      this.consume(e)
      let n = !1
      const s = this.takeWhile((u) =>
        n ? ((n = !1), u) : u === '\\' ? ((n = !0), '') : u != e ? u : null,
      )
      return (
        this.consume(e),
        {
  ...
  tokenizeIdentifier() {
    let e = !0
    const n = this.takeWhile((s) =>
      e ? ((e = !1), s.match(lC) ? s : null) : s.match(ku) ? s : null,
    )
    return n !== null
      ? {
          type: 'identifier',
  ...
  tokenizeNumber() {
    ...
    const a = this.takeWhile((f) =>
      f === '.' && !n && s ? ((n = !0), f) : ((s = !0), f.match(fC) ? f : null),
    )
    return a !== null
      ? {
          type: 'number',
...
class gC {
  ...
  parseSliceSelector() {
    ...
    return (
      this.match({type: 'operator', symbol: ':'}) && (u.step = this.parseNumberValue()),
      u.start === null && u.end === null ? ((this.i = e), null) : u
    )
  }
  parseValueReference() {
  ...
  parseFilterExpression() {
    const e = this.i,
      n = this.parseAttribute() || this.parseAlias()
    if (!n) return null
    if (this.match({type: 'operator', symbol: '?'}))
      return {
        type: 'constraint',
    ...
    if (!s || s.type !== 'comparator') return (this.i = e), null
    const u = n,
      a = this.parseLiteralValue()
    if (!a) throw new Error(`Operator ${s.symbol} needs a literal value at the right hand side`)
    return {
      type: 'constraint',
      operator: s.symbol,
      lhs: u,
  ...
  parseUnion() {
    if (!this.match({type: 'paren', symbol: '['})) return null
    const e = []
    let n = this.parseFilterExpression() || this.parsePath() || this.parseValueReference()
    for (; n && (e.push(n), !this.match({type: 'paren', symbol: ']'})); ) {
      if (!this.match({type: 'operator', symbol: ','})) throw new Error('Expected ]')
      if (
        ((n = this.parseFilterExpression() || this.parsePath() || this.parseValueReference()), !n)
      )
  ...
  parseRecursive() {
    if (!this.match({type: 'operator', symbol: '..'})) return null
    const e = this.parsePath()
    if (!e) throw new Error("Expected path following '..' operator")
    return {
      type: 'recursive',
      term: e,
    }
  ...
  parsePath() {
    const e = [],
      n = this.parseAttribute() || this.parseUnion() || this.parseRecursive()
    if (!n) return null
    for (e.push(n); !this.EOF(); )
      if (this.match({type: 'operator', symbol: '.'})) {
        const s = this.parseAttribute()
        if (!s) throw new Error("Expected attribute name following '.")
        e.push(s)
        continue
      } else if (this.probe({type: 'paren', symbol: '['})) {
        const s = this.parseUnion()
        if (!s) throw new Error("Expected union following '['")
        e.push(s)
      } else {
...
function ld(r) {
  ...
  if (!e) throw new Error(`Failed to parse JSON path "${r}"`)
  return e
}
function hd(r) {
  return qr(r, !1)
...
function qr(r, e) {
  switch (r.type) {
    ...
    case 'range': {
      ...
      return (
        e || n.push('['),
        r.start && n.push(`${r.start}`),
        n.push(':'),
        r.end && n.push(`${r.end}`),
        r.step && n.push(`:${r.step}`),
        e || n.push(']'),
        n.join('')
      )
    }
    ...
    case 'constraint': {
      const n = r.rhs ? ` ${qr(r.rhs, !1)}` : '',
        s = `${qr(r.lhs, !1)} ${r.operator}${n}`
      return e ? s : `[${s}]`
    }
    case 'string':
...
class Oe {
  constructor(e) {
    W(this, 'expr')
    if (!e) throw new Error('Attempted to create Expression from null-value')
  ...
  expandRange(e) {
    const n = () => {
      if (!e) throw new Error('expandRange() required a probe that was not passed')
      return e.length()
    }
  ...
  testConstraint(e) {
    ...
    if (n.type === 'constraint' && n.lhs.type === 'alias' && n.lhs.target === 'self') {
      if (e.containerType() !== 'primitive') return !1
      if (n.type === 'constraint' && n.operator === '?') return !0
      const f = e.get(),
        l = n.rhs && 'value' in n.rhs ? n.rhs.value : void 0
      return hl(f, n.operator, l)
    }
    if (n.type !== 'constraint') return !1
    const s = n.lhs
    if (!s) throw new Error('No LHS of expression')
    if (s.type !== 'attribute') throw new Error(`Constraint target ${s.type} not supported`)
    if (e.containerType() !== 'object') return !1
    const u = e.getAttribute(s.name)
    if (u == null || u.containerType() !== 'primitive') return !1
  ...
  toIndicies(e) {
    ...
    if (this.expr.type === 'index') return [Nu(this.expr.value, e)]
    const n = [],
      s = this.expandRange(e)
    let {start: u, end: a} = s
    s.step < 0 && ([u, a] = [a, u])
    for (let f = u; f < a; f++) n.push(f)
    return n
  }
  toFieldReferences() {
  ...
  static fromPath(e) {
    const n = ld(e)
    if (!n) throw new Error(`Failed to parse path "${e}"`)
    return new Oe(n)
  }
...
function Nu(r, e) {
  if (r >= 0) return r
  if (!e) throw new Error('interpretNegativeIndex() must have a probe when < 0')
  return r + e.length()
}
class Wr {
  constructor(e, n) {
  ...
  iterate(e) {
    ...
    if (this.head && this.head.isConstraint()) {
      let s = !0
      for (; s; )
        (n = Xn.flatten(n.map((u) => u.iterateConstraints(e)))),
  ...
  iterateConstraints(e) {
    const n = this.head
    if (n === null || !n.isConstraint()) return [this]
    const s = []
    ...
    return e.containerType() === 'object'
      ? n.constraintTargetIsSelf()
        ? []
        : n.testConstraint(e)
          ? this.descend()
          : s
  ...
  toString() {
    const e = ['<']
    return (
      this.head && e.push(this.head.toString()),
      e.push('|'),
      this.tail && e.push(this.tail.toString()),
      e.push('>'),
      e.join('')
    )
  }
...
class gr {
  constructor(e, n) {
    ...
    W(this, 'payload')
    ;(this.active = e || []),
      n ? ((this.recursives = n.recursives), (this.payload = n.payload)) : (this.recursives = []),
  ...
  extractRecursives() {
    this.active = this.active.filter((e) =>
      e.isRecursive() ? (this.recursives.push(...e.extractRecursives()), !1) : !0,
    )
  }
  ...
  activeRecursives(e) {
    return this.recursives.filter((n) => {
      const s = n.head
      return s
        ? s.isConstraint() || (e.containerType() === 'array' && s.isIndexReference())
          ? !0
          : e.containerType() === 'object'
            ? s.isAttributeReference() && e.hasAttribute(s.name())
            : !1
        : !1
    })
  }
  ...
  iterate(e) {
    const n = []
    return (
      this.active.concat(this.activeRecursives(e)).forEach((s) => {
        n.push(...s.iterate(e))
      }),
      new gr(n, this)
    )
  ...
  extractMatches(e) {
    ...
    if (
      (this.active.forEach((u) => {
        ...
        if (
          a &&
          !(e.containerType() === 'array' && !a.isIndexReference()) &&
          !(e.containerType() === 'object' && !a.isAttributeReference())
        )
          if (u.tail) {
  ...
  static fromPath(e) {
    const n = ld(e)
    if (!n) throw new Error(`Failed to parse path from "${e}"`)
...
class lo {
  ...
  getIndex(e) {
    return Array.isArray(this._value)
      ? e >= this.length()
        ? null
        : new lo(this._value[e], this.path.concat(e))
      : !1
  }
  hasAttribute(e) {
  ...
  getAttribute(e) {
    if (!Js(this._value)) throw new Error('getAttribute only applies to plain objects')
...
function vC(r, e) {
  const n = [],
    s = gr.fromPath(r).setPayload(function (f) {
      n.push(...f)
    }),
    u = new lo(e)
  return dd(s, u), n
...
function dl(r, e) {
  ...
  else if (r.isAttributeReference()) n.push(e.getAttribute(r.name()))
  else if (r.isSelfReference()) n.push(e)
  else throw new Error(`Unable to derive accessor for target ${r.toString()}`)
  return Xn.compact(n)
}
function mC(r, e) {
...
function pl(r, e) {
  ...
  for (let y = 0; y !== -1; ) {
    ...
    if (((y = s.indexOf(p)), y === -1)) return l
    ;(d += y), (y === 0 || n.substring(f - d) === s.substring(0, d)) && ((l = d), d++)
  }
  return l
}
function ga(r, e) {
  if (!r || !e || r[0] !== e[0]) return 0
  let n = 0,
    s = Math.min(r.length, e.length),
    u = s,
    a = 0
  for (; n < u; )
    r.substring(a, u) === e.substring(a, u) ? ((n = u), (a = n)) : (s = u),
      (u = Math.floor((s - n) / 2 + n))
  return u
}
function vo(r, e) {
  if (!r || !e || r[r.length - 1] !== e[e.length - 1]) return 0
  let n = 0,
    s = Math.min(r.length, e.length),
    u = s,
    a = 0
  for (; n < u; )
    r.substring(r.length - u, r.length - a) === e.substring(e.length - u, e.length - a)
      ? ((n = u), (a = n))
      : (s = u),
      (u = Math.floor((s - n) / 2 + n))
  return u
...
function pd(r) {
  ...
  for (; f < e.length; )
    e[f][0] === it
      ? ((s[u++] = f), (l = y), (d = p), (y = 0), (p = 0), (a = e[f][1]))
      : (e[f][0] === Rt ? (y += e[f][1].length) : (p += e[f][1].length),
        a &&
          a.length <= Math.max(l, d) &&
          a.length <= Math.max(y, p) &&
          (e.splice(s[u - 1], 0, [Et, a]),
          (e[s[u - 1] + 1][0] = Rt),
          u--,
          u--,
          (f = u > 0 ? s[u - 1] : -1),
  ...
  for (n && (e = mo(e)), e = gd(e), f = 1; f < e.length; ) {
    if (e[f - 1][0] === Et && e[f][0] === Rt) {
      const m = e[f - 1][1],
        ...
        I = pl(b, m)
      C >= I
        ? (C >= m.length / 2 || C >= b.length / 2) &&
          (e.splice(f, 0, [it, b.substring(0, C)]),
          (e[f - 1][1] = m.substring(0, m.length - C)),
          (e[f + 1][1] = b.substring(C)),
          f++)
        : (I >= m.length / 2 || I >= b.length / 2) &&
          (e.splice(f, 0, [it, m.substring(0, I)]),
          (e[f - 1][0] = Rt),
          (e[f - 1][1] = b.substring(0, b.length - I)),
          (e[f + 1][0] = Et),
          (e[f + 1][1] = m.substring(I)),
          f++),
        f++
    }
    f++
...
function gd(r) {
  ...
  for (; s < e.length - 1; ) {
    if (e[s - 1][0] === it && e[s + 1][0] === it) {
      ...
      e[s - 1][1] !== d &&
        (d ? (e[s - 1][1] = d) : (e.splice(s - 1, 1), s--),
        (e[s][1] = y),
        p ? (e[s + 1][1] = p) : (e.splice(s + 1, 1), s--))
    }
    s++
  }
  return e
      ...
      case it:
        s + u > 1
          ? (s !== 0 &&
              ...
              ((l = ga(f, a)),
              l !== 0 &&
                (n - s - u > 0 && e[n - s - u - 1][0] === it
                  ? (e[n - s - u - 1][1] += f.substring(0, l))
                  : (e.splice(0, 0, [it, f.substring(0, l)]), n++),
                (f = f.substring(l)),
                (a = a.substring(l))),
              (l = vo(f, a)),
              l !== 0 &&
                ((e[n][1] = f.substring(f.length - l) + e[n][1]),
                (f = f.substring(0, f.length - l)),
                (a = a.substring(0, a.length - l)))),
            (n -= s + u),
            e.splice(n, s + u),
            a.length && (e.splice(n, 0, [Et, a]), n++),
            f.length && (e.splice(n, 0, [Rt, f]), n++),
            n++)
          : n !== 0 && e[n - 1][0] === it
...
function CC(r) {
  let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 4,
    n = r.map((b) => Li(b)),
    s = !1
  const u = []
  let a = 0,
  ...
  for (; l < n.length; )
    n[l][0] === it
      ? (n[l][1].length < e && (p || m)
          ? ((u[a++] = l), (d = p), (y = m), (f = n[l][1]))
          : ((a = 0), (f = null)),
        (p = !1),
        (m = !1))
      : (n[l][0] === Et ? (m = !0) : (p = !0),
        f &&
          ((d && y && p && m) || (f.length < e / 2 && _C(d, y, p, m) === 3)) &&
          (n.splice(u[a - 1], 0, [Et, f]),
          (n[u[a - 1] + 1][0] = Rt),
          a--,
          (f = null),
          d && y
            ? ((p = !0), (m = !0), (a = 0))
            : (a--, (l = a > 0 ? u[a - 1] : -1), (p = !1), (m = !1)),
          (s = !0))),
      l++
  return s && (n = mo(n)), n
}
function EC(r, e, n) {
  ...
  for (let R = 0; R < a && !(Date.now() > n); R++) {
    for (let x = -R + b; x <= R - C; x += 2) {
      ...
      let M = U - x
      for (; U < s && M < u && r.charAt(U) === e.charAt(M); ) U++, M++
      if (((d[D] = U), U > s)) C += 2
      else if (M > u) b += 2
      else if (m) {
        const z = f + p - x
    ...
    for (let x = -R + I; x <= R - O; x += 2) {
      ...
      let M = U - x
      for (; U < s && M < u && r.charAt(s - U - 1) === e.charAt(u - M - 1); ) U++, M++
      if (((y[D] = U), U > s)) O += 2
      else if (M > u) I += 2
      else if (!m) {
        const z = f + p - x
        if (z >= 0 && z < l && d[z] !== -1) {
          const ht = d[z],
            _t = f + ht - z
          if (((U = s - U), ht >= U)) return yl(r, e, ht, _t, n)
        }
      }
    }
  }
...
function AC(r, e) {
  ...
  const s = r.length > e.length ? r : e,
    u = r.length > e.length ? e : r
  if (s.length < 4 || u.length * 2 < s.length) return null
  const a = wl(s, u, Math.ceil(s.length / 4)),
    f = wl(s, u, Math.ceil(s.length / 2))
  let l
  if (a && f) l = a[4].length > f[4].length ? a : f
  else {
    if (!a && !f) return null
    f ? a || (l = f) : (l = a)
  }
  if (!l) throw new Error('Unable to find a half match.')
  let d, y, p, m
  r.length > e.length
    ? ((d = l[0]), (y = l[1]), (p = l[2]), (m = l[3]))
    : ((p = l[0]), (m = l[1]), (d = l[2]), (y = l[3]))
  const b = l[4]
  return [d, y, p, m, b]
}
function wl(r, e, n) {
  ...
  for (; (u = e.indexOf(s, u + 1)) !== -1; ) {
    const p = ga(r.slice(n), e.slice(u)),
      m = vo(r.slice(0, n), e.slice(0, u))
    a.length < m + p &&
      ((a = e.slice(u - m, u) + e.slice(u, u + p)),
      (f = r.slice(0, n - m)),
      (l = r.slice(n + p)),
      (d = e.slice(0, u - m)),
      (y = e.slice(u + p)))
...
function xC(r, e) {
  for (let n = 0; n < r.length; n++) {
    const s = r[n][1],
      u = []
    for (let a = 0; a < s.length; a++) u[a] = e[s.charCodeAt(a)]
    r[n][1] = u.join('')
  }
}
function SC(r, e) {
...
`,
        ...
        m === -1 && (m = d.length - 1)
      let C = d.slice(p, m + 1)
      ;(s.hasOwnProperty ? s.hasOwnProperty(C) : s[C] !== void 0)
        ? (y += String.fromCharCode(s[C]))
        : (b === a && ((C = d.slice(p)), (m = d.length)),
    ...
    switch (l[d][0]) {
      ...
      case it:
        if (y >= 1 && p >= 1) {
          ...
          for (let I = C.length - 1; I >= 0; I--) l.splice(d, 0, C[I])
          d += C.length
        }
        ;(p = 0), (y = 0), (m = ''), (b = '')
        break
...
function IC(r, e, n) {
  ...
  if (!r) return [[Rt, e]]
  if (!e) return [[Et, r]]
  const u = r.length > e.length ? r : e,
    a = r.length > e.length ? e : r,
    f = u.indexOf(a)
  if (f !== -1)
    return (
      (s = [
        [Rt, u.substring(0, f)],
        [it, a],
        [Rt, u.substring(f + a.length)],
      ]),
      r.length > e.length && ((s[0][0] = Et), (s[2][0] = Et)),
      s
    )
  if (a.length === 1)
    return [
...
const Et = -1,
  ...
  it = 0
function vd(r, e, n) {
  if (r === null || e === null) throw new Error('Null input. (diff)')
  const s = vr(r, e, TC(n || {}))
  return $C(s), s
}
function vr(r, e, n) {
...
function LC(r, e, n, s) {
  return s === 1
    ? r[e][1][r[e][1].length - 1] === r[n][1][r[n][1].length - 1]
    : r[e][1][0] === r[n][1][0]
}
function bl(r, e, n) {
  const s = n === 1 ? -1 : 1
  ...
  ;(r[e][1] = l),
    u === null
      ? (r.splice(f, 0, [Rt, d]), a !== null && a >= f && a++)
      : (r[u][1] = Rs(r[u][1], d, s)),
    a === null ? r.splice(f, 0, [Et, d]) : (r[a][1] = Rs(r[a][1], d, s))
}
function $C(r) {
  ...
  for (let e = 0; e < r.length; e++) r[e][1].length === 0 && r.splice(e, 1)
}
const PC = {
  /**
...
function DC(r, e, n) {
  ...
  if (e.length > MC) throw new Error('Pattern too long for this browser.')
  const u = FC(s),
    a = UC(e)
  function f(I, O) {
    const R = I / e.length,
  ...
  d !== -1 &&
    ((l = Math.min(f(0, d), l)),
    (d = r.lastIndexOf(e, n + e.length)),
    d !== -1 && (l = Math.min(f(0, d), l)))
  ...
  for (let I = 0; I < e.length; I++) {
    ...
    const R = Math.min(n + m, r.length) + e.length,
      x = new Array(R + 2)
    x[R + 1] = (1 << I) - 1
    for (let D = R; D >= O; D--) {
      ...
      if (
        (I === 0
          ? (x[D] = ((x[D + 1] << 1) | 1) & U)
          : (x[D] = (((x[D + 1] << 1) | 1) & U) | (((C[D + 1] | C[D]) << 1) | 1) | C[D + 1]),
        x[D] & y)
      ) {
        const M = f(I, D - 1)
        if (M <= l)
          if (((l = M), (d = D - 1), d > n)) O = Math.max(1, 2 * n - d)
          else break
      }
    }
    if (f(I + 1, n) > l) break
...
function UC(r) {
  const e = {}
  for (let n = 0; n < r.length; n++) e[r.charAt(n)] = 0
  for (let n = 0; n < r.length; n++) e[r.charAt(n)] |= 1 << (r.length - n - 1)
  return e
}
function qu(r, e, n) {
  if (r === null || e === null || n === null) throw new Error('Null input. (match())')
  const s = Math.max(0, Math.min(n, r.length))
  if (r === e) return 0
  if (r.length) {
    if (r.substring(s, s + e.length) === e) return s
  } else return -1
  return DC(r, e, s)
}
function ho(r, e) {
...
function va(r) {
  const e = []
  for (let n = 0; n < r.length; n++) r[n][0] !== Rt && (e[n] = r[n][1])
  return e.join('')
}
function md(r) {
  const e = []
  for (let n = 0; n < r.length; n++) r[n][0] !== Et && (e[n] = r[n][1])
  return e.join('')
}
function Kn(r) {
  let e = 0
  for (let n = 0; n < r.length; n++) {
    ...
    if (typeof s > 'u') throw new Error('Failed to get codepoint')
    e += yd(s)
  }
  return e
}
function kC(r, e) {
  ...
  function a(l) {
    for (; s < l; ) {
      ...
      if (typeof d > 'u') return u
      ;(s += yd(d)), d > 65535 ? (u += 2) : (u += 1)
    }
    if (!n.allowExceedingIndices && s !== l) throw new Error('Failed to determine byte offset')
    return u
  }
  const f = []
  for (const l of r)
...
function qC(r, e, n) {
  ...
  if (r && Array.isArray(r) && typeof e > 'u') return Bu(va(r), r, Wu(n))
  if (typeof r == 'string' && e && Array.isArray(e)) return Bu(r, e, Wu(n))
...
function Bu(r, e, n) {
  ...
  for (let b = 0; b < e.length; b++) {
    const C = e[b],
      ...
      x = Kn(O)
    switch (
      (!a && I !== it && ((u.start1 = f), (u.start2 = l), (u.utf8Start1 = d), (u.utf8Start2 = y)),
      I)
    ) {
      case Rt:
        ;(u.diffs[a++] = C),
          (u.length2 += R),
          (u.utf8Length2 += x),
          (m = m.substring(0, l) + O + m.substring(l))
        break
      case Et:
        ;(u.length1 += R),
          (u.utf8Length1 += x),
          (u.diffs[a++] = C),
          (m = m.substring(0, l) + m.substring(l + R))
        break
      case it:
        R <= 2 * n.margin && a && e.length !== b + 1
          ? ((u.diffs[a++] = C),
            (u.length1 += R),
            (u.length2 += R),
            (u.utf8Length1 += x),
          ...
          : R >= 2 * n.margin &&
            a &&
            (_l(u, p, n), s.push(u), (u = ho(-1, -1)), (a = 0), (p = m), (f = l), (d = y))
        break
      default:
...
function _l(r, e, n) {
  if (e.length === 0) return
  let s = e.substring(r.start2, r.start2 + r.length1),
    u = 0
...
function Cl(r, e) {
  ...
  for (
    f = 0;
    f < r.length &&
    (r[f][0] !== Rt && (n += r[f][1].length), r[f][0] !== Et && (s += r[f][1].length), !(n > e));
    f++
  )
    (u = n), (a = s)
...
function BC(r) {
  ...
  let s = ''
  for (let f = 1; f <= n; f++) s += String.fromCharCode(f)
  for (const f of r) (f.start1 += n), (f.start2 += n), (f.utf8Start1 += n), (f.utf8Start2 += n)
  let u = r[0],
    a = u.diffs
  if (a.length === 0 || a[0][0] !== it)
    ...
    const f = a[0][1].length,
      l = n - f
    ;(a[0][1] = s.substring(f) + a[0][1]),
      (u.start1 -= l),
      (u.start2 -= l),
      (u.utf8Start1 -= l),
      (u.utf8Start2 -= l),
  ...
  if (((u = r[r.length - 1]), (a = u.diffs), a.length === 0 || a[a.length - 1][0] !== it))
    ...
    ;(a[a.length - 1][1] += s.substring(0, f)),
      (u.length1 += f),
      (u.length2 += f),
      (u.utf8Length1 += f),
      (u.utf8Length2 += f)
    ...
    for (; u.diffs.length !== 0; ) {
      ...
      for (; u.diffs.length !== 0 && d.length1 < n - e; ) {
        ...
        if (b === Rt) {
          ...
          b === Et && d.diffs.length === 1 && d.diffs[0][0] === it && C.length > 2 * n
            ? ((d.length1 += C.length),
              (d.utf8Length1 += I),
              (a += C.length),
              (y = !1),
            ...
            : ((C = C.substring(0, n - d.length1 - e)),
              ...
              C === u.diffs[0][1]
                ? u.diffs.shift()
                : (u.diffs[0][1] = u.diffs[0][1].substring(C.length)))
      }
      ;(l = md(d.diffs)), (l = l.substring(l.length - e))
      const p = va(u.diffs).substring(0, e),
        m = Kn(p)
      p !== '' &&
        ((d.length1 += p.length),
        (d.length2 += p.length),
        (d.utf8Length1 += m),
        (d.utf8Length2 += m),
        d.diffs.length !== 0 && d.diffs[d.diffs.length - 1][0] === it
          ? (d.diffs[d.diffs.length - 1][1] += p)
          : d.diffs.push([it, p])),
        y || r.splice(++s, 0, d)
    }
  }
...
function GC(r, e) {
  ...
  const u = kC(r, s, {
    ...
    a = n.margin || ma,
    f = n.deleteThreshold || 0.4,
    l = BC(u, a)
  ;(s = l + s + l), HC(u, a)
  let d = 0
  const y = []
  for (let p = 0; p < u.length; p++) {
    const m = u[p].start2 + d,
      b = va(u[p].diffs)
    let C,
      I = -1
    if (
      (b.length > Hn
        ? ((C = qu(s, b.substring(0, Hn), m)),
          C !== -1 &&
            ((I = qu(s, b.substring(b.length - Hn), m + b.length - Hn)),
            (I === -1 || C >= I) && (C = -1)))
        : (C = qu(s, b, m)),
      C === -1)
    )
      ...
      if ((I === -1 ? (O = s.substring(C, C + b.length)) : (O = s.substring(C, I + Hn)), b === O))
        ...
        if (b.length > Hn && WC(R) / b.length > f) y[p] = !1
        else {
          R = gd(R)
          let x = 0,
            D = 0
          for (let U = 0; U < u[p].diffs.length; U++) {
            ...
            M[0] !== it && (D = Cl(R, x)),
              M[0] === Rt
                ? (s = s.substring(0, C + D) + M[1] + s.substring(C + D))
                : M[0] === Et &&
                  (s = s.substring(0, C + D) + s.substring(C + Cl(R, x + M[1].length))),
              M[0] !== Et && (x += M[1].length)
          }
        }
      }
...
function zC(r) {
  const {utf8Length1: e, utf8Length2: n, utf8Start1: s, utf8Start2: u, diffs: a} = r
  let f
  e === 0
    ? (f = ''.concat(s, ',0'))
    : e === 1
      ? (f = ''.concat(s + 1))
      : (f = ''.concat(s + 1, ',').concat(e))
  let l
  n === 0
    ? (l = ''.concat(u, ',0'))
    : n === 1
      ? (l = ''.concat(u + 1))
      : (l = ''.concat(u + 1, ',').concat(n))
  const d = [
    '@@ -'.concat(f, ' +').concat(
      l,
      ` @@
...
`)
  ...
  for (; s < n.length; ) {
    ...
    if (!u) throw new Error('Invalid patch string: '.concat(n[s]))
    const a = ho(Os(u[1]), Os(u[3]))
    for (
      e.push(a),
        u[2] === ''
          ? (a.start1--, a.utf8Start1--, (a.length1 = 1), (a.utf8Length1 = 1))
          : u[2] === '0'
            ? ((a.length1 = 0), (a.utf8Length1 = 0))
            : (a.start1--, a.utf8Start1--, (a.utf8Length1 = Os(u[2])), (a.length1 = a.utf8Length1)),
        u[4] === ''
          ? (a.start2--, a.utf8Start2--, (a.length2 = 1), (a.utf8Length2 = 1))
          : u[4] === '0'
            ? ((a.length2 = 0), (a.utf8Length2 = 0))
            : (a.start2--, a.utf8Start2--, (a.utf8Length2 = Os(u[4])), (a.length2 = a.utf8Length2)),
        s++;
      s < n.length;
      ...
      if (l === '-') a.diffs.push([Et, d]), (a.length1 -= y)
      else if (l === '+') a.diffs.push([Rt, d]), (a.length2 -= y)
      else if (l === ' ') a.diffs.push([it, d]), (a.length1 -= y), (a.length2 -= y)
      else throw new Error('Invalid patch mode "'.concat(l, '" in: ').concat(d))
      s++
    }
  }
  return e
...
class XC {
  ...
  apply(e, n) {
    let s = n
    if (s.containerType() === 'primitive') return s
    for (const u of e) {
  ...
  apply(e, n) {
    ...
    return (
      e.forEach((u) => {
        if (!u.isIndexReference())
          if (u.isAttributeReference())
            s.containerType() === 'primitive'
              ? (s = s.set({[u.name()]: this.value}))
              : s.hasAttribute(u.name()) || (s = n.setAttribute(u.name(), this.value))
          else throw new Error(`Unable to apply to target ${u.toString()}`)
      }),
      s
    )
  }
...
class bd {
  ...
  apply(e, n) {
    ...
    return (
      e.forEach((u) => {
        if (u.isSelfReference()) s = s.set(this.value)
          ...
          s.containerType() === 'primitive'
            ? (s = s.set({[u.name()]: this.value}))
            : (s = s.setAttribute(u.name(), this.value))
        else throw new Error(`Unable to apply to target ${u.toString()}`)
      }),
      s
    )
...
function _d(r) {
  const e = []
  if (Array.isArray(r)) return r.reduce((y, p) => y.concat(_d(p)), e)
  ...
  if (
    ...
    let y, p
    const m = d
    if ('before' in m) (y = 'before'), (p = m.before)
    else if ('after' in m) (y = 'after'), (p = m.after)
    else if ('replace' in m) (y = 'replace'), (p = m.replace)
...
class tE {
  ...
  applyViaAccessor(e) {
    ...
    if (!s) throw new Error('Cannot apply patch to document with no _id')
    const u = s.get()
    ...
    u.forEach((f) => {
      if (f.target.isIndexReference())
        f.target.toIndicies().forEach((l) => {
          ...
          if (!d) throw new Error('Index out of bounds')
        ...
        if (
          (!l &&
            n &&
            ((s = s.setAttribute(f.target.name(), {})), (l = s.getAttribute(f.target.name()))),
          !l)
        )
          return
        const d = ra(f.matcher, l)
        l !== d && (s = s.setAttributeAccessor(f.target.name(), d))
      } else throw new Error(`Unable to handle target ${f.target.toString()}`)
    }),
    a && eE(a.payload) && (s = a.payload.apply(a.targets, s)),
    s
  )
}
function eE(r) {
...
var Zt = []
for (var Hu = 0; Hu < 256; ++Hu) Zt.push((Hu + 256).toString(16).substr(1))
function oE(r) {
...
class un {
  ...
  appliesToMissingDocument() {
    ...
    return (
      e
        ...
        : (this._appliesToMissingDocument = !0),
      this._appliesToMissingDocument
    )
  }
  ...
  compile() {
    ...
    this.mutations.forEach((u) => {
      ...
      typeof this.params.timestamp == 'string' &&
        e.push((u) => (u ? Object.assign(u, {_updatedAt: this.params.timestamp}) : null))
    const n = this.previousRev,
      s = this.resultRev || this.transactionId
    this.compiled = (u) => {
      if (n && u && n !== u._rev)
        throw new Error(
  ...
  static squash(e, n) {
    const s = n.reduce((u, a) => u.concat(...a.mutations), [])
...
class cE {
  ...
  // submission.
  stage(e, n) {
    if (!e.transactionId) throw new Error('Mutations _must_ have transactionId when submitted')
    ;(this.lastStagedAt = /* @__PURE__ */ new Date()),
      ct('Staging mutation %s (pushed to pending)', e.transactionId),
      this.pending.push(e),
      (this.EDGE = e.apply(this.EDGE)),
      this.onMutation &&
        !n &&
        this.onMutation({
          mutation: e,
  ...
  considerIncoming() {
    ...
    if (this.HEAD && this.HEAD._updatedAt) {
      ...
      this.incoming.find((f) => f.timestamp && f.timestamp < a) &&
        (this.incoming = this.incoming.filter((f) => f.timestamp && f.timestamp < a))
    }
    let u = 0
    do {
      if (this.HEAD) {
      ...
      } else n = this.incoming.find((a) => a.appliesToMissingDocument())
      if (n) {
        const a = this.applyIncoming(n)
        if (((e = e || a), e && s.push(n), u++ > 10))
          throw new Error(
            `Mutator stuck flushing incoming mutations. Probably stuck here: ${JSON.stringify(n)}`,
          )
      }
    } while (n)
    this.incoming.length > 0 &&
      ct.enabled &&
      ct('Unable to apply mutations %s', this.incoming.map((a) => a.transactionId).join(', ')),
      e && this.rebase(s)
  }
  // check current consistency state, update flag and invoke callback if needed
  updateConsistencyFlag() {
    const e = this.isConsistent(),
      n = this.pending.length === 0 && this.submitted.length === 0 && this.incoming.length === 0
    n
      ? (this.inconsistentAt = null)
      : this.inconsistentAt || (this.inconsistentAt = /* @__PURE__ */ new Date()),
      e != n &&
        this.onConsistencyChanged &&
        (ct(n ? 'Buffered document is inconsistent' : 'Buffered document is consistent'),
        this.onConsistencyChanged(n))
  }
  // apply an incoming patch that has been prequalified as the next in line for this document
  applyIncoming(e) {
    if (!e) return !1
    if (!e.transactionId) throw new Error('Received incoming mutation without a transaction ID')
    if (
      (ct(
      ...
      (this.HEAD = e.apply(this.HEAD)),
      this.onRemoteMutation && this.onRemoteMutation(e),
      (this.incoming = this.incoming.filter((n) => n.transactionId !== e.transactionId)),
      ...
      return (
        ct.enabled &&
          ...
          ct(`Submitted txnIds: ${this.submitted.map((s) => s.transactionId).join(', ')}`),
          ct(`Pending txnIds: ${this.pending.map((s) => s.transactionId).join(', ')}`),
          ct('needRebase === %s', n)),
        n
      )
    }
  ...
  consumeUnresolved(e) {
    ...
    return (
      ...
      (this.submitted = this.submitted.filter((n) => n.transactionId !== e)),
      (this.pending = this.pending.filter((n) => n.transactionId !== e)),
      ct('After scrubbing: Pending: %d, Submitted: %d', this.pending.length, this.submitted.length),
      !0
    )
  }
  ...
  rebase(e) {
    const n = this.EDGE
    ;(this.EDGE = un.applyAll(this.HEAD, this.submitted.concat(this.pending))),
      n !== null && this.EDGE !== null && (n._rev = this.EDGE._rev),
      !Xn.isEqual(this.EDGE, n) && this.onRebase && this.onRebase(this.EDGE, e, this.pending)
  }
}
class Ls {
  constructor(e) {
    ...
    W(this, 'staged')
    e
      ? ct('Reset mutation buffer to rev %s', e._rev)
      : ct('Reset mutation buffer state to document being deleted'),
      (this.staged = []),
      (this.setOperations = {}),
      (this.documentPresent = !1),
      (this.BASIS = e),
      (this.PRESTAGE = e)
  }
  add(e) {
  ...
  addOperation(e) {
    ...
    if (
      ...
      e.patch.set &&
      'id' in e.patch &&
      e.patch.id === ((n = this.PRESTAGE) == null ? void 0 : n._id) &&
      Object.keys(e.patch).length === 2
    ) {
      const s = e.patch.set,
        u = {}
      ...
      Object.keys(u).length > 0 &&
        (ct('Unoptimizable set-operation detected, purging optimization buffer'),
        this.staged.push({patch: {id: this.PRESTAGE._id, set: u}}),
        this.stashStagedOperations())
      return
    }
    if (e.createIfNotExists && this.PRESTAGE && e.createIfNotExists._id === this.PRESTAGE._id) {
      this.documentPresent ||
        (this.staged.push(e), (this.documentPresent = !0), this.stashStagedOperations())
      return
    }
    ct('Unoptimizable mutation detected, purging optimization buffer'),
      this.staged.push(e),
      this.stashStagedOperations()
  }
  /**
  ...
  optimiseSetOperation(e, n) {
    ...
    const u = s[0]
    if (typeof u.value == 'object' || !this.PRESTAGE) return !1
    let a = null
    if (u.value === n) a = null
    ...
    else a = {patch: {id: this.PRESTAGE._id, set: {[e]: n}}}
    const f = iC(u.path)
  ...
  stashStagedOperations() {
    ...
    Object.keys(this.setOperations).forEach((n) => {
      ...
      e.push(...this.staged),
      e.length > 0 &&
        ((this.PRESTAGE = new un({mutations: e}).apply(this.PRESTAGE)),
        (this.staged = []),
        (this.setOperations = {})),
      this.out.push(...e)
  }
  ...
  rebase(e) {
    return (
      this.stashStagedOperations(),
      e === null
        ? ((this.out = []), (this.BASIS = e), (this.PRESTAGE = e), (this.documentPresent = !1))
        : ((this.BASIS = e),
          this.out
            ? (this.PRESTAGE = new un({mutations: this.out}).apply(this.BASIS))
...
class hE {
  constructor(e) {
    ...
    ;(this.buffer = new Ls(e)),
      (this.document = new cE(e)),
      (this.document.onMutation = (n) => this.handleDocMutation(n)),
      (this.document.onRemoteMutation = (n) => this.onRemoteMutation && this.onRemoteMutation(n)),
      (this.document.onRebase = (n, s, u) => this.handleDocRebase(n, s, u)),
      (this.document.onConsistencyChanged = (n) => this.handleDocConsistencyChanged(n)),
      (this.LOCAL = e),
      (this.mutations = []),
      (this.commits = [])
  }
  ...
  reset(e) {
    e
      ? ct('Document state reset to revision %s', e._rev)
      : ct('Document state reset to being deleted'),
      this.document.reset(e),
      this.rebase([], []),
      this.handleDocConsistencyChanged(this.document.isConsistent())
  }
  // Add a change to the buffer
  add(e) {
    this.onConsistencyChanged && this.onConsistencyChanged(!1),
      ct('Staged local mutation'),
      this.buffer.add(e)
    const n = this.LOCAL
    ;(this.LOCAL = e.apply(this.LOCAL)),
      this.onMutation &&
        n !== this.LOCAL &&
        (ct('onMutation fired'),
        this.onMutation({
  ...
  arrive(e) {
    if (
      (ct('Remote mutation arrived %s -> %s', e.previousRev, e.resultRev),
      e.previousRev === e.resultRev)
    )
      throw new Error(
  ...
  commit() {
    return new Promise((e, n) => {
      ...
      this.commits.push(new lE(s ? [s] : [], {resolve: e, reject: n})),
        (this.buffer = new Ls(this.LOCAL)),
        this.performCommits()
    })
  }
  ...
  _cycleCommitter() {
    ...
    const n = e.squash(this.LOCAL),
      s = this.document.stage(n, !0),
      u = {
        success: () => {
        ...
        failure: () => {
          ct('Commit failed'),
            (e.tries += 1),
            this.LOCAL !== null && this.commits.unshift(e),
            s.failure(),
            e.tries < 200 && setTimeout(() => this._cycleCommitter(), Math.min(e.tries * 1e3, fE))
        },
        cancel: (a) => {
          this.commits.forEach((f) => f.reject(a)),
            (this.commits = []),
  ...
  handleDocMutation(e) {
    if (this.commits.length === 0 && !this.buffer.hasChanges()) {
      ct('Document mutated from remote with no local changes'),
        (this.LOCAL = this.document.EDGE),
        (this.buffer = new Ls(this.LOCAL)),
        this.onMutation && this.onMutation(e)
      return
    }
    ct('Document mutated from remote with local changes'),
      this.document.EDGE === null && this.handleDocumentDeleted(),
      this.rebase([e.mutation], [])
  }
  rebase(e, n) {
    ct('Rebasing document'), this.document.EDGE === null && this.handleDocumentDeleted()
    const s = this.LOCAL
    ;(this.LOCAL = this.commits.reduce((a, f) => f.apply(a), this.document.EDGE)),
      (this.LOCAL = this.buffer.rebase(this.LOCAL)),
      s !== null && this.LOCAL !== null && (s._rev = this.LOCAL._rev),
      !Xn.isEqual(this.LOCAL, s) &&
        this.onRebase &&
        this.onRebase(this.LOCAL, e.reduce(Sl, []), n.reduce(Sl, []))
  }
...
const Rl = (r) => {
  ...
  dE = (r) => {
    const e = new Je(),
      ...
      l = (x) => {
        const D = new hE(x)
        return (
          (D.onMutation = ({mutation: U, remote: M}) => {
            s.next({
              type: 'mutation',
              document: Rl(D),
      ...
      p = e.pipe(
        rl(d),
        Zu(([x, D]) => {
          x.type === 'mutation' && D.add(new un({mutations: x.mutations})),
            x.type === 'commit' && D.commit()
        }),
      ...
      m = (x) => e.next(x),
      b = (x) => m({type: 'mutation', mutations: x}),
      C = (x) => b([x]),
      I = () => {
        d.pipe(
          mh(1),
      ...
      O = Hr(d.pipe(Lt((x) => x.LOCAL)), s.pipe(Lt(Ol)), u.pipe(Lt(Ol)), y).pipe(
        Lt(Il),
        Ss(1),
        mi(),
      ),
  ...
  gE = {type: 'pending', phase: 'begin'},
  vE = {type: 'pending', phase: 'end'}
function mE(r) {
...
function wE(r) {
  ...
  return Object.values(e).every((n) => n.length === n[0].transactionTotalEvents)
}
function bE(r, e, n = {}) {
  ...
  return pb(() =>
    ...
    el((f) =>
      f.type === 'welcome' ? a().pipe(el((l) => [Ll(u, l.draft), Ll(s, l.published)])) : gh(f),
    ),
    yh(
      (f, l) => {
        if (!mE(l)) return {next: [l], buffer: []}
        const d = f.buffer.length > 0,
          y = yE(l)
        if (!y && !d) return {next: [l], buffer: []}
        if (!y) return {next: [], buffer: f.buffer.concat(l)}
        const p = f.buffer.concat(l)
        return wE(p)
          ? {next: p.concat(vE), buffer: []}
          : {next: p.length === 1 ? [gE] : [], buffer: p}
      },
      {next: [], buffer: []},
    ),
...
function _E(r) {
  if (!r._id) throw new Error('Expected document to have an _id')
}
function CE(r, e) {
  ...
  return s.mutations
    .flatMap((a) => {
      ...
      if (f.length > 1) throw new Error('Did not expect multiple mutations in the same payload')
...
function AE(r, e, n) {
  return CE(n, e.publishedId)
    ? Cd(r, n)
    : r.observable.action(EE(e, n), {
        tag: 'document.commit',
...
function xE(r, e, n, s) {
  return Ii(s ? AE(r, e, n.mutation.params) : Cd(r, n.mutation.params)).pipe(
    Zu({
      error: (u) => {
        'statusCode' in u &&
...
function SE(r, e, n) {
  const {publishedId: s, draftId: u} = e,
    a = new Je(),
    f = bE(r, e).pipe(Vu({connector: () => a})),
    l = f.pipe(Xe((b) => b.type === 'reconnect')),
    d = Tl(u, f.pipe(Xe($l(u)))),
    y = Tl(s, f.pipe(Xe($l(s)))),
    p = f.pipe(Xe((b) => b.type === 'pending')),
...
self.addEventListener('message', (r) => {
  if (RE(r.data))
    if (r.data.type === 'construct') {
      ...
      const {clientConfig: e, idPair: n, serverActionsEnabled: s} = r.data,
        u = V_(e)
      jt = SE(u, n, gh(s))
      const {complete: a} = jt,
        f = []
      f.push(
        ...
        (jt.complete = () => {
          for (const l of f) l.unsubscribe()
          ;(f.length = 0), a()
        })
    } else if (jt)
      switch (r.data.type) {
    ...
    else throw new Error('Received message before instance was constructed', {cause: r})
})
function ar(r) {
  self.postMessage(r)
}
...
function Ad(r) {
  ...
  return r.reduce((e, n, s) => {
    const u = typeof n
    if (u === 'number') return `${e}[${n}]`
    if (u === 'string') return `${e}${s === 0 ? '' : '.'}${n}`
    if (IE(n) && n._key) return `${e}[_key=="${n._key}"]`
    if (Array.isArray(n)) {
      const [a, f] = n
      return `${e}[${a}:${f}]`
    }
...
function LE(r, e) {
  ...
  const s = Object.entries(e.mappings)
    .filter(([l]) => n.startsWith(l))
    .sort(([l], [d]) => d.length - l.length)
  if (s.length == 0) return
  const [u, a] = s[0],
    f = n.substring(u.length)
...
function Xs(r, e, n = []) {
  return $E(r)
    ? r.map((s, u) => {
        if (Dl(s)) {
          const a = s._key
          if (typeof a == 'string') return Xs(s, e, n.concat({_key: a, _index: u}))
        }
        return Xs(s, e, n.concat(u))
      })
    : Dl(r)
      ? Object.fromEntries(Object.entries(r).map(([s, u]) => [s, Xs(u, e, n.concat(s))]))
      : e(r, n)
}
function Sd(r, e, n) {
  return Xs(r, (s, u) => {
    ...
    if (f.type !== 'value' || f.source.type !== 'documentValue') return s
    const d = e.documents[f.source.document],
      y = e.paths[f.source.path],
      p = Ml(l),
      m = Ml(y).concat(u.slice(p.length))
    return n({
      sourcePath: m,
      sourceDocument: d,
      resultPath: u,
...
function FE(r) {
  ...
  if (!f) throw new Error('path is required')
  if (!u) throw new Error('id is required')
  if (e !== '/' && e.endsWith('/')) throw new Error('baseUrl must not end with a slash')
  const y = n === 'default' ? void 0 : n,
    p = s === 'default' ? void 0 : s,
    m = PE(u),
    b = Array.isArray(f) ? Ad(xd(f)) : f,
  ...
  y && C.set('workspace', y),
    ...
    l && C.set('projectId', l),
    d && C.set('dataset', d),
    u.startsWith(ia) && C.set('isDraft', '')
  const I = [e === '/' ? '' : e]
  y && I.push(y)
  const O = ['mode=presentation', `id=${m}`, `type=${a}`, `path=${encodeURIComponent(b)}`]
...
function ME(r) {
  ...
  return (
    e !== '/' && (e = e.replace(/\/$/, '')),
    typeof r == 'string' ? {baseUrl: e} : {...r, baseUrl: e}
  )
}
const Gu = ({sourcePath: r, resultPath: e, value: n}) => {
    if (UE(n) || kE(n)) return !1
    const s = r.at(-1)
    return !(
      (r.at(-2) === 'slug' && s === 'current') ||
      (typeof s == 'string' && s.startsWith('_')) ||
      (typeof s == 'number' && r.at(-2) === 'marks') ||
      (s === 'href' && typeof r.at(-2) == 'number' && r.at(-3) === 'markDefs') ||
      s === 'style' ||
      s === 'listItem' ||
      r.some((u) => u === 'meta' || u === 'metadata' || u === 'openGraph' || u === 'seo') ||
      Ul(r) ||
      Ul(e) ||
      (typeof s == 'string' && DE.has(s))
    )
  },
  DE = /* @__PURE__ */ new Set([
    'color',
...
function Rd(r, e, n) {
  ...
  if (!I) {
    ...
    throw (
      ((s = C == null ? void 0 : C.error) == null ||
        s.call(C, `[@sanity/client]: ${x}`, {result: r, resultSourceMap: e, config: n}),
      new TypeError(x))
    )
  }
  if (!e)
    return (
      (u = C == null ? void 0 : C.error) == null ||
        u.call(C, '[@sanity/client]: Missing Content Source Map from response body', {
          result: r,
          resultSourceMap: e,
          config: n,
        }),
  ...
  if (!n.studioUrl) {
    ...
    throw (
      ((a = C == null ? void 0 : C.error) == null ||
        a.call(C, `[@sanity/client]: ${x}`, {result: r, resultSourceMap: e, config: n}),
      new TypeError(x))
    )
  }
  const O = {
    ...
    R = Sd(r, e, ({sourcePath: x, sourceDocument: D, resultPath: U, value: M}) => {
      if (
        (typeof b == 'function'
          ? b({sourcePath: x, resultPath: U, filterDefault: Gu, sourceDocument: D, value: M})
          : Gu({sourcePath: x, resultPath: U, filterDefault: Gu, sourceDocument: D, value: M})) ===
        !1
      )
        return (
          C &&
      ...
      const {
        ...
        workspace: ht,
        tool: _t,
      } = ME(typeof n.studioUrl == 'function' ? n.studioUrl(D) : n.studioUrl)
      if (!z) return M
  ...
  if (C) {
    const x = O.skipped.length,
      D = O.encoded.length
    if (
      ((x || D) &&
        ((f = (C == null ? void 0 : C.groupCollapsed) || C.log) == null ||
          f('[@sanity/client]: Encoding source map into result'),
        (l = C.log) == null ||
          l.call(
            C,
      ...
      O.encoded.length > 0 &&
        ((d = C == null ? void 0 : C.log) == null ||
          d.call(C, '[@sanity/client]: Table of encoded paths'),
        (y = (C == null ? void 0 : C.table) || C.log) == null || y(O.encoded)),
      O.skipped.length > 0)
    ) {
      const U = /* @__PURE__ */ new Set()
      for (const {path: M} of O.skipped) U.add(M.replace(Ed, '0').replace(/\[\d+\]/g, '[]'))
      ;(p = C == null ? void 0 : C.log) == null ||
        p.call(C, '[@sanity/client]: List of skipped paths', [...U.values()])
    }
...
;(function (r, e) {
  ;(function (n) {
    ...
    if (
      ...
      ;(m = function (L, k) {
        var H = k.signal
        return R(L, {headers: k.headers, credentials: k.credentials, cache: k.cache}).then(
          function (N) {
            var Y = N.body.getReader()
            return (
              (H._reader = Y),
              H._aborted && H._reader.cancel(),
              {
                status: N.status,
    ...
    x.prototype.decode = function (L) {
      function k(ft, yt, V) {
        if (V === 1) return ft >= 128 >> yt && ft << yt <= 2047
        if (V === 2)
          return (ft >= 2048 >> yt && ft << yt <= 55295) || (ft >= 57344 >> yt && ft << yt <= 65535)
        if (V === 3) return ft >= 65536 >> yt && ft << yt <= 1114111
        throw new Error()
      }
      function H(ft, yt) {
        if (ft === 6 * 1) return yt >> 6 > 15 ? 3 : yt > 31 ? 2 : 1
        if (ft === 6 * 2) return yt > 15 ? 3 : 2
        if (ft === 6 * 3) return 3
        throw new Error()
      }
      for (
        var N = 65533, Y = '', G = this.bitsNeeded, Q = this.codePoint, mt = 0;
        mt < L.length;
        mt += 1
      ) {
        var ut = L[mt]
        G !== 0 &&
          (ut < 128 || ut > 191 || !k((Q << 6) | (ut & 63), G - 6, H(G, Q))) &&
          ((G = 0), (Q = N), (Y += String.fromCharCode(Q))),
          G === 0
            ? (ut >= 0 && ut <= 127
                ? ((G = 0), (Q = ut))
                : ut >= 192 && ut <= 223
                  ...
                  : ut >= 224 && ut <= 239
                    ...
                    : ut >= 240 && ut <= 247
                      ? ((G = 6 * 3), (Q = ut & 7))
                      : ((G = 0), (Q = N)),
              G !== 0 && !k(Q, G, H(G, Q)) && ((G = 0), (Q = N)))
            : ((G -= 6), (Q = (Q << 6) | (ut & 63))),
          G === 0 &&
            (Q <= 65535
              ? (Y += String.fromCharCode(Q))
              : ((Y += String.fromCharCode(55296 + ((Q - 65535 - 1) >> 10))),
                (Y += String.fromCharCode(56320 + ((Q - 65535 - 1) & 1023)))))
      }
    ...
    ;(M.prototype.open = function (L, k) {
      ...
      this._abort = function (V) {
        H._sendTimeout !== 0 && (u(H._sendTimeout), (H._sendTimeout = 0)),
          (Y === 1 || Y === 2 || Y === 3) &&
            ((Y = 4),
            (N.onload = U),
            (N.onerror = U),
            ...
            N.abort(),
            G !== 0 && (u(G), (G = 0)),
            V || ((H.readyState = 4), H.onabort(null), H.onreadystatechange())),
          (Y = 0)
      }
      var Q = function () {
          if (Y === 1) {
            var V = 0,
              pt = '',
              we = void 0
            if ('contentType' in N) (V = 200), (pt = 'OK'), (we = N.contentType)
            else
              try {
        ...
        ut = function (V, pt) {
          if (
            ((pt == null || pt.preventDefault == null) &&
              (pt = {
                preventDefault: U,
              }),
            mt(),
            ...
            if (((Y = 4), G !== 0 && (u(G), (G = 0)), (H.readyState = 4), V === 'load'))
              H.onload(pt)
            else if (V === 'error') H.onerror(pt)
            else if (V === 'abort') H.onabort(pt)
        ...
        ft = function (V) {
          N != null &&
            (N.readyState === 4
              ? (!('onload' in N) || !('onerror' in N) || !('onabort' in N)) &&
                ut(N.responseText === '' ? 'error' : 'load', V)
              : N.readyState === 3
                ? 'onprogress' in N || mt()
                : N.readyState === 2 && Q())
        },
      ...
      'onload' in N &&
        ...
        'onabort' in N &&
          (N.onabort = function (V) {
            ut('abort', V)
          }),
        'onprogress' in N && (N.onprogress = mt),
        'onreadystatechange' in N &&
          (N.onreadystatechange = function (V) {
            ft(V)
          }),
        ('contentType' in N || !('ontimeout' in a.prototype)) &&
          (k += (k.indexOf('?') === -1 ? '?' : '&') + 'padding=true'),
        N.open(L, k, !0),
        'readyState' in N &&
          (G = s(function () {
            yt()
      ...
      (M.prototype.send = function () {
        if (
          (!('ontimeout' in a.prototype) ||
            (!('sendAsBinary' in a.prototype) && !('mozAnon' in a.prototype))) &&
          y != null &&
          y.readyState != null &&
          y.readyState !== 'complete'
        ) {
...
`),
        ...
        (L.onreadystatechange = function () {
          if (L.readyState === a.HEADERS_RECEIVED) {
            var ft = L.status,
              ...
              pt = L.getAllResponseHeaders()
            k(ft, yt, V, new ht(pt))
          }
        }),
        (L.withCredentials = G)
      for (var ut in Q) Object.prototype.hasOwnProperty.call(Q, ut) && L.setRequestHeader(ut, Q[ut])
      return L.send(), L
    }
    function xt(L) {
      this._headers = L
      ...
      return (
        m(Y, {
          ...
          .then(function (V) {
            return (
              (mt = V.body.getReader()),
              k(V.status, V.statusText, V.headers.get('Content-Type'), new xt(V.headers)),
              new p(function (pt, we) {
                var ln = function () {
                  mt.read()
                    .then(function (Kt) {
                      if (Kt.done) pt(void 0)
                      else {
    ...
    ;(qe.prototype.dispatchEvent = function (L) {
      ...
      (qe.prototype.addEventListener = function (L, k) {
        ...
        var H = this._listeners,
          N = H[L]
        N == null && ((N = []), (H[L] = N))
        for (var Y = !1, G = 0; G < N.length; G += 1) N[G] === k && (Y = !0)
        Y || N.push(k)
      }),
      (qe.prototype.removeEventListener = function (L, k) {
        ...
        var H = this._listeners,
          N = H[L]
        if (N != null) {
          for (var Y = [], G = 0; G < N.length; G += 1) N[G] !== k && Y.push(N[G])
    ...
    function ye(L, k, H) {
      ...
      var N = !!H.withCredentials,
        Y = H.lastEventIdQueryParameterName || 'lastEventId',
        G = fn(1e3),
        Q = cn(H.heartbeatTimeout, 45e3),
        mt = '',
        ut = G,
        ft = !1,
        yt = 0,
        V = H.headers || {},
        pt = H.Transport,
        we = Pi && pt == null ? void 0 : new M(pt != null ? new pt() : br()),
        ln = pt != null && typeof pt != 'string' ? new pt() : we == null ? new Te() : new _t(),
        Kt = void 0,
        Nt = 0,
        oe = Yr,
        tn = '',
...
`.charCodeAt(0) ||
            ...
            ;(In = (Ot === -1 ? In : '') + Dt.slice(Ot + 1)),
              Dt !== '' && ((ft = Date.now()), (yt += Dt.length))
...
`.charCodeAt(0))
                ...
                if (Jt !== kt) {
                  Jt === Vr && (hn = $t + 1)
                  var Be = Xt.slice(Zr, hn - 1),
                    _e = Xt.slice(
                      hn + (hn < $t && Xt.charCodeAt(hn) === ' '.charCodeAt(0) ? 1 : 0),
                      $t,
                    )
                  Be === 'data'
                    ? ((tn += `
`),
              ...
              Di(
                new Error(
                  'No activity within ' +
                    Q +
                    ' milliseconds. ' +
                    (oe === te ? 'No response received.' : yt + ' chars received.') +
                    ' Reconnecting.',
                ),
              ),
                Kt != null && (Kt.abort(), (Kt = void 0))
          ...
          if (k.slice(0, 5) !== 'data:' && k.slice(0, 5) !== 'blob:' && mt !== '') {
            ...
            ;(Ot =
              ue === -1
                ? k
                : k.slice(0, ue + 1) +
                  k.slice(ue + 1).replace(/(?:^|&)([^=&]*)(?:=[^&]*)?/g, function (_e, On) {
                    return On === Y ? '' : _e
                  })),
              (Ot += (k.indexOf('?') === -1 ? '?' : '&') + Y + '=' + encodeURIComponent(mt))
          }
          var ae = L.withCredentials,
            Xt = {}
          Xt.Accept = 'text/event-stream'
          var $t = L.headers
          if ($t != null)
            for (var Be in $t) Object.prototype.hasOwnProperty.call($t, Be) && (Xt[Be] = $t[Be])
          try {
    ...
    ;(ee.prototype = Object.create(qe.prototype)),
      (ee.prototype.CONNECTING = te),
      (ee.prototype.OPEN = se),
      (ee.prototype.CLOSED = Yn),
      ...
      (ee.OPEN = se),
      (ee.CLOSED = Yn),
      (ee.prototype.withCredentials = void 0)
    var Sn = d
    a != null && (d == null || !('withCredentials' in d.prototype)) && (Sn = ee),
      (function (L) {
        {
          var k = L(e)
...
var WE = sa.exports,
  BE = WE.EventSourcePolyfill
const HE = /* @__PURE__ */ ad(BE),
